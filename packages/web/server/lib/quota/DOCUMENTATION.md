...
| `cursor` | Cursor | `providers/cursor.js` | Environment/token files, MittrCraft-managed credentials, or explicit one-time Cursor import |
...
| `ollama-cloud` | Ollama Cloud | `providers/ollama-cloud.js` | Manual cookie stored under `~/.config/mittrcraft/quota/` |
