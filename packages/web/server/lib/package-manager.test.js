...
describe('checkForUpdates', () => {
  ...
  it('resolves an Android APK asset when the update API returns an AAB', async () => {
    fetchMock
      .when('api.openchamber.dev', {
        ...
        json: async () => ({
          latestVersion: '1.10.0',
          updateAvailable: true,
          downloadUrl: 'https://github.com/openchamber/openchamber/releases/download/v1.10.0/Mittr Craft-1.10.0-42-android.aab',
        }),
      })
      .when('api.github.com/repos/openchamber/openchamber/releases/tags/v1.10.0', {
        ...
        json: async () => ({
          assets: [
            {
              name: 'Mittr Craft-1.10.0-42-android.aab',
              browser_download_url: 'https://downloads.example/Mittr Craft-1.10.0-42-android.aab',
            },
            {
            ...
            {
              name: 'Mittr Craft-1.10.0-42-android.apk',
              browser_download_url: 'https://downloads.example/Mittr Craft-1.10.0-42-android.apk',
            },
          ],
        }),
      });
    ...
    expect(result.downloadUrl).toBe('https://downloads.example/Mittr Craft-1.10.0-42-android.apk');
  });

  it('keeps a direct Android APK URL from the update API', async () => {
    const apkUrl = 'https://github.com/openchamber/openchamber/releases/download/v1.10.0/Mittr Craft-1.10.0-42-android.apk';
