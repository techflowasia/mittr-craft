 ...
 * on a page directly. It publishes a request over the existing Mittr Craft
    ...
    request(action, parameters = {}, { timeoutMs = DEFAULT_TIMEOUT_MS, signal } = {}) {
      ...
      if (!listenerCount) {
        ...
        return Promise.reject(new BrowserControlError(
          'No Mittr Craft client connected here can control a page. Reading and '
          + 'interacting with a page works when Mittr Craft runs as its desktop '
