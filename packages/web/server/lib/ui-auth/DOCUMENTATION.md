...
## Purpose
This module owns MittrCraft UI authentication for browser access, including password session auth, Microsoft Entra ID OIDC, WebAuthn passkeys, and trusted-device session handling.
