...
@available(iOS 18.0, *)
struct MittrCraftNewSessionControl: ControlWidget {
    var body: some ControlWidgetConfiguration {
        StaticControlConfiguration(kind: "MittrCraftNewSessionControl") {
...
struct OpenNewSessionIntent: AppIntent {
    ...
    func perform() async throws -> some IntentResult & OpensIntent {
        return .result(opensIntent: OpenURLIntent(URL(string: "mittrcraft://new")!))
    }
}
