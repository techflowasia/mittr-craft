...
struct OverviewWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("MittrCraft")
...
struct QuickActionsWidget: Widget {
    let kind = "MittrCraftQuickActions"
...
struct LockAttentionWidget: Widget {
    let kind = "MittrCraftLockAttention"
...
@main
struct MittrCraftWidgetBundle: WidgetBundle {
