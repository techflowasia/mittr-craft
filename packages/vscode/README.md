...
Plus everything from the shared Mittr Craft UI: branchable timeline, smart tool UIs, voice mode, Git workflows, and more.

## Commands

| Command | Description |
|---------|-------------|
| `Mittr Craft: Focus Chat` | Focus the chat panel |
| `Mittr Craft: New Session` | Start a new chat session |
| `Mittr Craft: Open Sidebar` | Open the Mittr Craft sidebar |
| `Mittr Craft: Open Agent Manager` | Launch parallel multi-model runs |
| `Mittr Craft: Open Session in Editor` | Open current or new session in an editor tab |
| `Mittr Craft: Settings` | Open extension settings |
| `Mittr Craft: Restart API Connection` | Restart the OpenCode API process |
| `Mittr Craft: Show OpenCode Status` | Debug info for development or bug reports |

### Right-click menu

Select code in the editor, right-click, and find the **Mittr Craft** submenu:
