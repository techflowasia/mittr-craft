# MittrCraft Docs Source

This package is the source-of-truth for MittrCraft public docs content.
...
Website rendering/deployment happens in `mittrcraft-website` (`apps/docs`).
