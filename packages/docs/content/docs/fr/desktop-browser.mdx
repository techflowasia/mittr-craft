...
**Effacer les cookies** et **Effacer les données en cache** ne concernent que ce panneau. Votre session Mittr Craft et les autres fenêtres n'y touchent pas.
...
Les actions du navigateur constituent l'**outil Mittr Craft Web**, qui s'active et se désactive séparément dans **Réglages → Général → Outils Mittr Craft**.
