...
Cuando el agente se detiene y la sesión queda en silencio un momento, MittrCraft:
...
- El bucle del objetivo corre en el servidor de MittrCraft, no en tu pestaña del navegador. Cierra la pestaña, bloquea el teléfono — el agente sigue trabajando y recibirás una notificación cuando el objetivo termine. El servidor (app de escritorio o proceso `mittrcraft`) debe seguir en marcha.
