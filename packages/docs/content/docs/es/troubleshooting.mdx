...
## El comando MittrCraft se cierra o no arranca

- confirma que Node.js es `>=22`
- ejecuta `mittrcraft --version`
- reinstala la última CLI si hace falta

## No se puede acceder a la UI web

- revisa los logs del servidor con `mittrcraft logs`
...
- confirma que el servidor de MittrCraft está en marcha
