...
description: Instala la app de Mittr Craft en iOS o Android y conéctala a tu servidor.
---

# Apps móviles y PWA

Mittr Craft tiene apps nativas para iPhone y Android, para que puedas seguir sesiones, responder a los agentes y gestionar el trabajo desde tu teléfono, en casa por Wi-Fi o desde cualquier lugar a través del [Private Relay](/es/private-relay/).
...
1. En la computadora donde se ejecuta Mittr Craft, abre **Settings → Remote Instances → Conectarse a este servidor** y pulsa **Añadir un dispositivo**.
...
En **Settings → Mittr Craft**, unas cuantas opciones ajustan la experiencia móvil e instalada: el nombre de la app instalada, la orientación de la pantalla y el comportamiento del teclado en pantalla.
