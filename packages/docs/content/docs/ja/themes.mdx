---
title: テーマ
description: 組み込みテーマとユーザー定義テーマで Mittr Craft をカスタマイズします。
---

# テーマ

Mittr Craft は組み込みテーマとカスタムテーマ JSON ファイルに対応しています。
...
3. Mittr Craft を開き、**Settings -> Theme -> Reload themes** に移動します。
