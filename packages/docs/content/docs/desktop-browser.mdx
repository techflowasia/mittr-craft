...
**Clear cookies** and **Clear cached data** apply to this panel alone. Your Mittr Craft session and any other window are untouched.
...
The browser actions are the **Mittr Craft Web tool**, which can be turned on and off on its own in **Settings → General → Mittr Craft Tools**.
