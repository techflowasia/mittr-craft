...
description: Install the Mittr Craft app on iOS or Android and connect it to your server.
---

# Mobile Apps & PWA

Mittr Craft has native apps for iPhone and Android, so you can watch sessions, reply to agents, and manage work from your phone — at home over Wi-Fi or from anywhere over the [Private Relay](/private-relay/).
...
1. On the computer running Mittr Craft, open **Settings → Remote Instances → Connect to this server** and press **Add a device**.
...
Under **Settings → Mittr Craft**, a few options tune the mobile and installed experience — the app's installed name, screen orientation, and how the on-screen keyboard behaves.
