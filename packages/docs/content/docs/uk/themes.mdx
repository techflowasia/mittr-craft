---
title: Теми
description: Налаштуйте Mittr Craft за допомогою вбудованих і власних тем.
---

# Теми

Mittr Craft підтримує вбудовані теми та власні JSON-файли тем.
...
3. Відкрийте Mittr Craft, потім перейдіть до **Settings -> Theme -> Reload themes**.
