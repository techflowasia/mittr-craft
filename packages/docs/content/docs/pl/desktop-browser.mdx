...
**Wyczyść ciasteczka** i **Wyczyść dane w pamięci podręcznej** dotyczą wyłącznie tego panelu. Twoja sesja Mittr Craft i pozostałe okna zostają nietknięte.
...
Działania w przeglądarce to **narzędzie Mittr Craft Web**, które włącza się i wyłącza osobno w **Ustawienia → Ogólne → Narzędzia Mittr Craft**.
