---
title: Motywy
description: Dostosuj Mittr Craft za pomocą wbudowanych i własnych motywów.
---

# Motywy

Mittr Craft obsługuje wbudowane motywy oraz własne pliki JSON z motywami.
...
3. Otwórz Mittr Craft, a następnie przejdź do **Settings -> Theme -> Reload themes**.
