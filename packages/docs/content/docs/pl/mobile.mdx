...
description: Zainstaluj aplikację Mittr Craft na iOS lub Androidzie i połącz ją ze swoim serwerem.
---

# Aplikacje mobilne i PWA

Mittr Craft ma natywne aplikacje na iPhone'a i Androida, więc możesz obserwować sesje, odpowiadać agentom i zarządzać pracą z telefonu — w domu przez Wi-Fi lub z dowolnego miejsca przez [Private Relay](/pl/private-relay/).
...
1. Na komputerze z uruchomionym Mittr Craft otwórz **Settings → Remote Instances → Połącz z tym serwerem** i naciśnij **Dodaj urządzenie**.
...
W **Settings → Mittr Craft** kilka opcji dostraja działanie na telefonie i zainstalowanej aplikacji — nazwę zainstalowanej aplikacji, orientację ekranu i zachowanie klawiatury ekranowej.
