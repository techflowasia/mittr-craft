...
## O comando MittrCraft encerra ou não inicia

- confirme o Node.js `>=22`
- execute `mittrcraft --version`
- reinstale a CLI mais recente se necessário

## A UI web não está acessível

- verifique os logs do servidor com `mittrcraft logs`
...
- confirme que o servidor do MittrCraft está em execução
