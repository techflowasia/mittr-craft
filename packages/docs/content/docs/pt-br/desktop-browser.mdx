...
**Limpar cookies** e **Limpar dados em cache** valem só para este painel. Sua sessão do Mittr Craft e as outras janelas ficam intactas.
...
As ações do navegador são a **ferramenta Mittr Craft Web**, que pode ser ligada e desligada por conta própria em **Configurações → Geral → Ferramentas do Mittr Craft**.
