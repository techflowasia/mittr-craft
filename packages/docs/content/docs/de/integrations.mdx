...
Wir haben diese Integrationen so entwickelt, dass sie die vorgesehenen Anmeldewege der Anbieter nutzen und bekannte Verstöße gegen deren Nutzungsbedingungen vermeiden. Wir können nicht garantieren, dass ein Anbieter jede Nutzung oder jedes Konto akzeptiert. Lies die Bedingungen des Anbieters und nutze Integrationen auf eigenes Risiko. OpenChamber kann keine Kontobeschränkungen, Sperrungen oder Streitfälle mit einem Anbieter klären.
