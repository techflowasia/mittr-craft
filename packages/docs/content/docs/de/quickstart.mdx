---
title: Schnellstart
description: Starte Mittr Craft schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das Mittr Craft-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
...
Du solltest die Mittr Craft-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
