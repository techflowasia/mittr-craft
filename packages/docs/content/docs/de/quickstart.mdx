---
title: Schnellstart
description: Starte MittrCraft schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das MittrCraft-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
3. Führe `mittrcraft --ui-password be-creative-here` aus.
...
Du solltest die MittrCraft-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
