...
Die Desktop-App kann unter **Settings → Mittr Craft → Tunnel** einen öffentlichen Tunnel erstellen. Für diesen Weg musst du Mittr Craft nicht per CLI starten.

## Anbieter installieren

Mittr Craft startet das Provider-CLI auf deinem Rechner. Installiere zuerst den Anbieter, den du verwenden möchtest:
...
1. Öffne **Settings → Mittr Craft → Tunnel**.
