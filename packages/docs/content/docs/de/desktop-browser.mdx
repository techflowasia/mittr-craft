...
**Cookies löschen** und **Zwischengespeicherte Daten löschen** gelten allein für dieses Panel. Deine Mittr Craft-Sitzung und andere Fenster bleiben unberührt.
...
Die Browser-Aktionen sind das **Mittr Craft-Web-Werkzeug**, das sich unter **Einstellungen → Allgemein → Mittr Craft-Werkzeuge** einzeln ein- und ausschalten lässt.
