---
title: Reverse Proxy
description: Konfigurieren Sie MittrCraft korrekt hinter Nginx, Nginx Proxy Manager oder einem anderen Reverse Proxy.
---

# Reverse Proxy

Nutzen Sie diese Seite, wenn MittrCraft hinter Nginx, Nginx Proxy Manager, Caddy, Cloudflare oder einem anderen Reverse Proxy läuft.

## Bevor Sie es proxyen

1. Bestätigen Sie zuerst, dass MittrCraft direkt funktioniert.
...
- Deaktivieren Sie gzip auf dem Proxy, wenn MittrCraft Antworten bereits komprimiert.
...
- MittrCraft direkt im LAN erreichbar
...
- MittrCraft komprimiert HTTP-Antworten mit gzip (Schwelle 1 KB).
...
SSE-Streaming-Routen sind von MittrCraft von der Komprimierung ausgeschlossen, das CDN kann sie aber trotzdem puffern. Prüfen Sie in der CDN-Dokumentation, wie sich Buffering auf SSE-Pfaden deaktivieren lässt.
