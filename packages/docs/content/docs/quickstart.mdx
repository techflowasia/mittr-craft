---
title: Quickstart
description: Start MittrCraft quickly and pick the right app for the task.
---
...
2. Install the MittrCraft CLI (see [Install](/install/) for the one-line command).
...
You should see the MittrCraft session list in your browser. If it loads, you're up and running.
