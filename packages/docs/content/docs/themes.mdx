---
title: Themes
description: Customize Mittr Craft with built-in and user-defined themes.
---

# Themes

Mittr Craft supports built-in themes and custom theme JSON files.
...
3. Open Mittr Craft, then go to **Settings -> Theme -> Reload themes**.
