...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.weekStartsOn',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.darkTheme',
  ...
  },
  {
    ...
    descriptionKey: 'settings.mittrcraft.visual.field.dockBadgeHint',
    keywords: ['dock', 'badge', 'unread', 'unseen', 'counter', 'count', 'notification', 'macos'],
    // Exactly matches the render guard in MittrCraftVisualSettings: any darwin
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.installAppName',
    descriptionKey: 'settings.mittrcraft.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.installOrientation',
    descriptionKey: 'settings.mittrcraft.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.mittrcraft.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.terminal-shell',
    page: 'general',
    titleKey: 'settings.mittrcraft.visual.field.terminalShell',
    descriptionKey: 'settings.mittrcraft.visual.field.terminalShellHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.editorFontSize',
    keywords: ['editor', 'font', 'text size', 'code'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.mittrcraft.visual.field.inputBarOffset',
    descriptionKey: 'settings.mittrcraft.visual.field.inputBarOffsetTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.visual.field.autoSaveEnabled',
    descriptionKey: 'settings.mittrcraft.visual.field.autoSaveEnabledInfo',
    keywords: ['editor', 'autosave', 'auto-save', 'files', 'save'],
  },
  {
    id: 'appearance.expanded-editor-toolbar',
    page: 'general',
    titleKey: 'settings.mittrcraft.visual.field.expandedEditorToolbar',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.terminal-quick-keys',
    page: 'general',
    titleKey: 'settings.mittrcraft.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.mittrcraft.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.mittrcraft.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'general',
    titleKey: 'settings.mittrcraft.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.session-recap',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.sessionRecap',
    keywords: ['recap', 'assist', 'small model', 'summary'],
  },
  {
    id: 'chat.session-assistance',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.section.sessionAssistance',
    keywords: ['recap', 'suggestion', 'subagent'],
  },
  {
    id: 'chat.session-suggestion',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.sessionSuggestion',
    keywords: ['suggestion', 'assist', 'small model', 'follow up'],
  },
  {
    id: 'chat.session-goal',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.sessionGoal',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.goal.budgetLabel',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.reasoning',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.section.reasoning',
    keywords: ['thinking', 'traces'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.prompt-navigator',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.promptNavigatorEnabled',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.message-appearance',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.section.messageAppearance',
    keywords: ['layout', 'messages', 'appearance'],
  },
  {
    id: 'chat.code-block-line-wrap',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.codeBlockLineWrap',
    keywords: ['code', 'wrap', 'line wrap', 'markdown'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.mittrcraft.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.draft-starters-visible',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.draftStartersVisible',
    keywords: ['starter', 'starters', 'new session', 'welcome', 'suggestions'],
  },
  {
    id: 'chat.subagent-read-only-banner',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.allowPromptingSubagentSessions',
    keywords: ['subagent', 'read only', 'prompt', 'banner'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.tools-and-files',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.section.toolsAndFiles',
    keywords: ['tools', 'files', 'dotfiles'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.showDotfiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.section.followUpBehavior',
    descriptionKey: 'settings.mittrcraft.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.composer',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.section.composer',
    keywords: ['input', 'draft', 'spellcheck'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.mittrcraft.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.mittrcraft.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.mittrcraft.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.mittrcraft.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.mittrcraft.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.small-model',
    page: 'sessions',
    titleKey: 'settings.mittrcraft.defaults.smallModel.title',
    descriptionKey: 'settings.mittrcraft.defaults.smallModel.description',
    keywords: ['small model', 'utility', 'summary', 'recap', 'cheap', 'override'],
  },
  {
    id: 'sessions.walkthrough-model',
    page: 'sessions',
    titleKey: 'settings.mittrcraft.defaults.walkthroughModel.title',
    descriptionKey: 'settings.mittrcraft.defaults.walkthroughModel.description',
  ...
  },
  {
    ...
    descriptionKey: 'settings.mittrcraft.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.mittrcraft.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.mittrcraft.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'general',
    titleKey: 'settings.mittrcraft.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.mittrcraft.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.desktopNetwork.field.windowControlsPosition',
    descriptionKey: 'settings.mittrcraft.desktopNetwork.field.windowControlsPositionDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.mittrcraft.desktopNetwork.field.windowControlsStyle',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.desktopNetwork.field.macMenuBar',
    descriptionKey: 'settings.mittrcraft.desktopNetwork.field.macMenuBarDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.desktopNetwork.field.minimizeToTray',
    descriptionKey: 'settings.mittrcraft.desktopNetwork.field.minimizeToTrayDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.desktopNetwork.field.keepAwake',
    descriptionKey: 'settings.mittrcraft.desktopNetwork.field.keepAwakeDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.desktopPassword.field.password',
    descriptionKey: 'settings.mittrcraft.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.mittrcraft.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.mittrcraft.tools.field.agentControlTool',
    descriptionKey: 'settings.mittrcraft.tools.field.agentControlToolInfo',
    keywords: ['agent', 'tool', 'orchestration', 'mittrcraft', 'sessions', 'schedule', 'control'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-web-tool',
    page: 'general',
    titleKey: 'settings.mittrcraft.tools.field.agentWebTool',
    descriptionKey: 'settings.mittrcraft.tools.field.agentWebToolInfo',
    keywords: ['agent', 'tool', 'web', 'browser', 'page', 'preview', 'mittrcraft'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.mittrcraft.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.mittrcraft.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.mittrcraft.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.mittrcraft.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.mittrcraft.keyboardShortcuts.title',
    descriptionKey: 'settings.mittrcraft.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.mittrcraft.tunnel.field.provider',
    descriptionKey: 'settings.mittrcraft.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.mittrcraft.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.mittrcraft.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.mittrcraft.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.mittrcraft.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.mittrcraft.tunnel.field.configurationFile',
    descriptionKey: 'settings.mittrcraft.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.mittrcraft.tunnel.actions.startTunnel',
    descriptionKey: 'settings.mittrcraft.tunnel.note.connectLinksOneTime',
  ...
  },
  {
    ...
    keywords: ['claude', 'anthropic', 'claude code', 'pro', 'max', 'agent sdk', '@mittrcraft/opencode-claude'],
  },
  {
    ...
    keywords: ['command code', 'commandcode', 'laguna', 'poolside', 'gateway', '@mittrcraft/opencode-commandcode'],
  },
  {
    ...
    keywords: ['cursor', 'oauth', 'subscription', 'openai compatible', '@mittrcraft/opencode-cursor'],
  },
] as const;
