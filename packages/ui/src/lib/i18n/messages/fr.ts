...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Installez MittrCraft pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'MittrCraft installé',
  ...
  "sessions.myWork.dialog.projectMenu.label": "Dans quel projet commencer ?",
  "sessions.myWork.dialog.projectMenu.empty": "Ajoutez d'abord un projet",
  ...
  'sessions.sidebar.footer.actions.aboutMittrCraft': 'À propos de MittrCraft',
  ...
  'sessions.sidebar.footer.profile.details.department': 'Service',
  'sessions.sidebar.footer.profile.details.jobTitle': 'Intitulé du poste',
  'sessions.sidebar.footer.profile.details.groups': 'Groupes',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur MittrCraft auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans MittrCraft. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'contextSidebar.activity.title': 'Activité',
  'contextSidebar.activity.subagent': 'Sous-agent',
  'contextSidebar.activity.subagentUntitled': 'Sous-agent sans titre',
  'contextSidebar.activity.elapsed': '{duration} écoulées',
  'contextSidebar.activity.tokens': '{input} en entrée · {output} en sortie',
  'contextSidebar.activity.step': 'Étape {index} sur {total}',
  'contextSidebar.activity.working': 'En cours',
  'contextSidebar.activity.modelTokens': '{model} · {tokens} jetons',
  'contextSidebar.activity.empty': 'Aucune activité pour le moment',
  'contextSidebar.rawMessages.roleUser': 'Utilisateur',
  'contextSidebar.rawMessages.column.tokens': 'entrée / sortie',
  'contextSidebar.rawMessages.tokensAria': '{input} jetons en entrée, {output} jetons en sortie',
  ...
  'chat.goal.dialog.titleCreate': 'Définir un objectif Mittr',
  'chat.goal.dialog.titleManage': 'Objectif Mittr',
  ...
  'chat.goal.button.armAria': 'Démarrer un objectif Mittr avec le prochain message',
  ...
  'chat.goal.criteria.title': 'Terminé quand',
  'chat.goal.criteria.progress': '{met}/{total} faits',
  'chat.goal.criteria.pendingContract': 'Ce que « terminé » veut dire est fixé après le premier tour.',
  'chat.goal.criteria.status.met': 'Rempli',
  'chat.goal.criteria.status.missing': 'Pas encore rempli',
  'chat.goal.criteria.status.needsPerson': 'Vous attend',
  'chat.goal.criteria.status.pending': 'Pas encore vérifié',
  'chat.goal.criteria.checkedBy.script': 'vérifié par script',
  'chat.goal.criteria.checkedBy.mittr': 'jugé par Mittr',
  'chat.goal.criteria.checkedBy.model': 'jugé par le modèle',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'MittrCraft doit accéder à ce dossier.',
  ...
  'aboutDialog.mittrCraftVersionLabel': 'Version MittrCraft {version}',
  'aboutDialog.openCodeVersionLabel': 'Version MittrCraft Engine {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état MittrCraft, l’état de santé MittrCraft Engine, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans MittrCraft',
  ...
  'header.actions.openAppMenu': 'Menu de MittrCraft',
  'header.actions.openAppMenuAria': 'Ouvrir le menu MittrCraft',
  ...
  'chat.emptyState.opencodeUnreachable': 'MittrCraft Engine n\'est pas accessible',
  ...
  'openCodeStatusDialog.title': 'Statut MittrCraft Engine',
  'openCodeStatusDialog.description': 'Inspectez l’état et les diagnostics actuels du MittrCraft Engine.',
  ...
  'mcpDropdown.empty.configureInConfig': 'Configurez les serveurs MCP dans la configuration MittrCraft Engine.',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez MittrCraft depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez MittrCraft',
  ...
  'sessionAuth.locked.microsoftDescription': 'Connectez-vous avec votre compte Microsoft.',
  'sessionAuth.locked.microsoftBrowserDescription': 'La connexion Microsoft est disponible dans un navigateur.',
  'sessionAuth.actions.signInWithMicrosoft': 'Se connecter avec Microsoft',
  'sessionAuth.divider.or': 'ou',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs MittrCraft locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution MittrCraft.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur MittrCraft',
  ...
  'onboarding.localSetup.title': 'Configuration de MittrCraft Engine',
  'onboarding.localSetup.description': 'Installez MittrCraft Engine pour continuer.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Sélectionnez le binaire MittrCraft Engine',
  'onboarding.localSetup.errors.cliNotReady': 'MittrCraft Engine n’est pas encore prêt. Veuillez confirmer que l\'installation est terminée et réessayer.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si MittrCraft ne détecte pas automatiquement MittrCraft Engine, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'MittrCraft Engine est le cœur de MittrCraft — installez-le pour commencer.',
  'onboarding.localSetup.docs.windows': 'Documents MittrCraft Engine Windows + WSL',
  'onboarding.localSetup.docs.default': 'Documents MittrCraft Engine',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Cliquez pour vérifier si MittrCraft Engine est disponible. En cas de succès, vous entrerez automatiquement dans l\'écran principal.',
  'onboarding.localSetup.status.watching': 'En attendant MittrCraft Engine',
  'onboarding.localSetup.status.autoContinue': 'Nous continuerons automatiquement une fois qu’il sera détecté.',
  'onboarding.localSetup.field.alreadyInstalled': 'Déjà installé ? Définissez le chemin MittrCraft Engine :',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres MittrCraft et recharge la configuration MittrCraft Engine.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'Sous Windows, installez et exécutez MittrCraft Engine dans WSL pour une meilleure compatibilité.',
  ...
  'onboarding.localSetup.hint.ensurePath': 'Déjà installé ? Assurez-vous qu\'MittrCraft Engine est dans votre PATH.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur MittrCraft auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur MittrCraft ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas MittrCraft. Vérifiez que l\'adresse pointe vers un serveur MittrCraft.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'MittrCraft Engine local indisponible',
  'onboarding.desktopRecovery.localUnavailable.description': 'MittrCraft Engine n\'a pas pu être démarré ou n\'est pas installé. Installez MittrCraft Engine ou connectez-vous plutôt à un serveur distant.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas MittrCraft. Vérifiez que l\'adresse pointe vers un serveur MittrCraft.',
  ...
  'startup.initRecovery.description': 'MittrCraft n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de MittrCraft...',
  ...
  'updateDialog.error.takingLonger': 'La mise à jour prend plus de temps que prévu. Attendez un peu et actualisez, ou exécutez : mittrcraft update',
  'mobileUpdate.toast.available.title': 'Mise à jour MittrCraft disponible',
  ...
  'sidebar.resize.leftPanelAria': 'Redimensionner la barre latérale',
  ...
  'mobile.connect.welcome.title': 'Se connecter à MittrCraft',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe MittrCraft',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion MittrCraft.',
  ...
  'mobile.connect.relay.badge': 'via MittrCraft Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur MittrCraft.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve MittrCraft, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge MittrCraft. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à MittrCraft — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’MittrCraft. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute MittrCraft mais n’est pas compatible avec cette version de l’application. Mettez MittrCraft à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur MittrCraft à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez MittrCraft à jour sur le serveur, puis réessayez.',
