...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Installez Mittr Craft pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'Mittr Craft installé',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'À propos de Mittr Craft',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur Mittr Craft auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans Mittr Craft. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Mittr Craft doit accéder à ce dossier.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Version Mittr Craft {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état Mittr Craft, l’état de santé OpenCode, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans Mittr Craft',
  ...
  'header.actions.openAppMenu': 'Menu de Mittr Craft',
  'header.actions.openAppMenuAria': 'Ouvrir le menu Mittr Craft',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez Mittr Craft depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez Mittr Craft',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs Mittr Craft locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution Mittr Craft.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur Mittr Craft',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si Mittr Craft ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de Mittr Craft — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres Mittr Craft et recharge la configuration OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur Mittr Craft auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur Mittr Craft ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas Mittr Craft. Vérifiez que l\'adresse pointe vers un serveur Mittr Craft.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas Mittr Craft. Vérifiez que l\'adresse pointe vers un serveur Mittr Craft.',
  ...
  'startup.initRecovery.description': 'Mittr Craft n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de Mittr Craft...',
  ...
  'mobileUpdate.toast.available.title': 'Mise à jour Mittr Craft disponible',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Gardez Mittr Craft ouvert.',
  ...
  'openChamberLogo.aria.logo': 'Logo Mittr Craft',
  ...
  'mobile.connect.welcome.title': 'Se connecter à Mittr Craft',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe Mittr Craft',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion Mittr Craft.',
  ...
  'mobile.connect.relay.badge': 'via Mittr Craft Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur Mittr Craft.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve Mittr Craft, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge Mittr Craft. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à Mittr Craft — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente de Mittr Craft. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute Mittr Craft mais n’est pas compatible avec cette version de l’application. Mettez Mittr Craft à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur Mittr Craft à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez Mittr Craft à jour sur le serveur, puis réessayez.',
