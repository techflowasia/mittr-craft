...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'À propos de MittrCraft',
  ...
  'aboutDialog.openChamberVersionLabel': 'Version MittrCraft {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état MittrCraft, l’état de santé OpenCode, les répertoires et les projets.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si MittrCraft ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de MittrCraft — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres MittrCraft et recharge la configuration OpenCode.',
