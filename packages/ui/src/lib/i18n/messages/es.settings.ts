...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copia el ID desde la URL del panel y la cookie auth desde las herramientas del navegador. Mittr Craft nunca examina las cookies del navegador.',
  ...
  "settings.window.description": "Ventana de configuración de Mittr Craft.",
  ...
  "settings.page.appearance.description": "Personaliza el aspecto y la sensación de Mittr Craft.",
  ...
  "settings.remoteInstances.direct.title": "Otros servidores de Mittr Craft",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Añade otro servidor de Mittr Craft por URL. Úsalo cuando el servidor ya esté en marcha y tengas un token de conexión.",
  ...
  "settings.remoteInstances.direct.import.description": "Pega un enlace de conexión de otro servidor de Mittr Craft.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Enlace de conexión de Mittr Craft no válido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crea un enlace o token seguro para que Mittr Craft Desktop pueda conectarse a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "Mittr Craft connection QR code",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Ampliar código QR",
  "settings.remoteInstances.clientAuth.qrScanHint": "Escanéalo con la app de Mittr Craft en tu otro dispositivo. Es de un solo uso y caduca.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona en casa y fuera. Fuera de casa el tráfico pasa por Mittr Craft Private Relay, un túnel cifrado de extremo a extremo. Sin configuración.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escanea este código QR con la app de Mittr Craft en tu otro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Elige si Mittr Craft debe iniciar el servidor por ti o conectarse a uno que ya está en marcha.",
  ...
  "settings.remoteInstances.page.field.keepServerRunningHint": "Keep Mittr Craft running on the remote machine after you disconnect.",
  ...
  "settings.openchamber.about.title": "Acerca de Mittr Craft",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Añade un repositorio Git como nuevo origen de catálogo. Mittr Craft escaneará para encontrar carpetas que contengan",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar Mittr Craft al iniciar sesión",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar Mittr Craft al iniciar sesión",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar Mittr Craft en la barra de menús de macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar Mittr Craft en la barra de menús",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Requiere reiniciar la aplicación. Al desactivarlo, Mittr Craft no crea el elemento de la barra de menús ni ejecuta sus actualizaciones de sesiones, aprobaciones y uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Cerrar Mittr Craft a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Cerrar a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantiene Mittr Craft en ejecución en la bandeja del sistema cuando se cierra la ventana principal. Al minimizar, la ventana sigue en la barra de tareas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Mantener el ordenador activo mientras Mittr Craft está en ejecución",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Mantener el ordenador activo mientras Mittr Craft está en ejecución",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "Mittr Craft la pide después del reinicio y luego cuando vence la sesión: tras 12 horas, o 7 días con Confiar en este dispositivo. Déjalo vacío para desactivar el inicio de sesión.",
  ...
  "settings.openchamber.tools.title": "Herramientas de Mittr Craft",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Herramienta Mittr Craft Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Activar la herramienta Mittr Craft Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permite que los agentes vean la página en el panel de navegador de Mittr Craft e interactúen con ella: abrir una URL, leer el contenido, hacer clic, escribir, desplazarse y alternar entre diseño móvil y de escritorio. Añade una pequeña descripción de herramienta a cada sesión. Se aplica tras reiniciar OpenCode.",
  ...
  "settings.remoteInstances.page.description": "Conéctate a otra máquina por SSH y abre Mittr Craft allí.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "Mittr Craft en la máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Elige cómo debe ejecutarse Mittr Craft después de conectar por SSH.",
  "settings.remoteInstances.page.section.mainTunnel": "Acceso local",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Elige la dirección local que se usará para abrir este servidor remoto de Mittr Craft.",
  "settings.remoteInstances.page.section.authentication": "Autenticación",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciales opcionales para SSH y la interfaz de usuario de Mittr Craft remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Cómo debe colocarse Mittr Craft en la máquina remota cuando esta app lo inicia por ti.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Instalando Mittr Craft",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Actualizando Mittr Craft",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Se guarda en la autenticación de OpenCode, no en Mittr Craft. Usa {env:VAR_NAME} para leer una clave del entorno.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Las claves se envían directamente a OpenCode y nunca se almacenan en Mittr Craft.",
  ...
  "settings.github.page.flow.title": "Autorizar Mittr Craft",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponible como respaldo si se elimina la autenticación de Mittr Craft",
  ...
  "settings.notifications.page.testNotification.body": "Esta es una notificación de prueba de Mittr Craft.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcripción local en el servidor de Mittr Craft. Los modelos se descargan automáticamente; no se necesita clave de API.",
  "settings.voice.page.tooltip.localTts": "Síntesis local en el servidor de Mittr Craft (Kokoro, inglés). El modelo se descarga automáticamente; no se necesita clave de API.",
