...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.about.title": "Acerca de MittrCraft",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar MittrCraft al iniciar sesión",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar MittrCraft al iniciar sesión",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar MittrCraft en la barra de menús de macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar MittrCraft en la barra de menús",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Requiere reiniciar la aplicación. Al desactivarlo, MittrCraft no crea el elemento de la barra de menús ni ejecuta sus actualizaciones de sesiones, aprobaciones y uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Cerrar MittrCraft a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Cerrar a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantiene MittrCraft en ejecución en la bandeja del sistema cuando se cierra la ventana principal. Al minimizar, la ventana sigue en la barra de tareas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Mantener el ordenador activo mientras MittrCraft está en ejecución",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Mantener el ordenador activo mientras MittrCraft está en ejecución",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "MittrCraft la pide después del reinicio y luego cuando vence la sesión: tras 12 horas, o 7 días con Confiar en este dispositivo. Déjalo vacío para desactivar el inicio de sesión.",
  ...
  "settings.openchamber.tools.title": "Herramientas de MittrCraft",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Herramienta MittrCraft Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Activar la herramienta MittrCraft Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permite que los agentes vean la página en el panel de navegador de MittrCraft e interactúen con ella: abrir una URL, leer el contenido, hacer clic, escribir, desplazarse y alternar entre diseño móvil y de escritorio. Añade una pequeña descripción de herramienta a cada sesión. Se aplica tras reiniciar OpenCode.",
  "settings.openchamber.tools.field.agentMemoryTool": "Herramienta de memoria del agente",
  "settings.openchamber.tools.field.agentMemoryToolAria": "Activar la herramienta de memoria del agente",
  "settings.openchamber.tools.field.agentMemoryToolInfo": "Permite que los agentes conserven lo aprendido entre sesiones en dos almacenes: lo que es cierto sobre ti y lo que es cierto sobre cada proyecto. Las sesiones reciben los títulos guardados para que el agente pueda leer una entrada cuando sea relevante. Al desactivarla se eliminan la herramienta, la pestaña Memoria y el índice de la sesión. Se aplica tras reiniciar OpenCode.",
  ...
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Actualizando MittrCraft",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Se guarda en la autenticación de OpenCode, no en MittrCraft. Usa {env:VAR_NAME} para leer una clave del entorno.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Las claves se envían directamente a OpenCode y nunca se almacenan en MittrCraft.",
