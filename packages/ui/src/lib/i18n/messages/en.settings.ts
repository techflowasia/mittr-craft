...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.description': 'Connect the MittrCraft Engine Go dashboard to show rolling, weekly, and monthly quota.',
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. MittrCraft never scans browser cookie storage.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'Could not validate MittrCraft Engine Go credentials.',
  'settings.providers.page.openCodeGo.valid': 'MittrCraft Engine Go credentials are valid.',
  'settings.providers.page.openCodeGo.invalid': 'MittrCraft Engine Go credentials are invalid or expired.',
  'settings.providers.page.openCodeGo.deleted': 'MittrCraft Engine Go credentials deleted.',
  'settings.providers.page.openCodeGo.deleteFailed': 'Could not delete MittrCraft Engine Go credentials.',
  ...
  'settings.window.description': 'MittrCraft settings window.',
  ...
  'settings.view.actions.reloadOpenCode': 'Reload MittrCraft Engine',
  'settings.view.actions.reloadOpenCodeTooltip': 'Restart MittrCraft Engine and reload its configuration.',
  'settings.view.actions.applyAndRestartOpenCode': 'Apply & Restart',
  'settings.view.actions.applyAndRestartOpenCodeTooltipSingle': 'Apply 1 pending configuration change and restart MittrCraft Engine.',
  'settings.view.actions.applyAndRestartOpenCodeTooltipPlural': 'Apply {count} pending configuration changes and restart MittrCraft Engine.',
  'settings.view.pendingRestart.applying': 'Restarting...',
  'settings.view.pendingRestart.applied': 'MittrCraft Engine restarted with pending configuration changes.',
  'settings.view.pendingRestart.applyFailed': 'Failed to apply configuration changes.',
  'settings.view.pendingRestart.manualRestartRequired': 'Saved on disk. Restart your connected MittrCraft Engine server to apply the changes.',
  'settings.view.pendingRestart.saved': 'Saved. Restart MittrCraft Engine to apply.',
  'settings.view.pendingRestart.confirm.title': 'Apply & restart?',
  'settings.view.pendingRestart.confirm.description': 'Restarting MittrCraft Engine will stop any running chats. Your saved configuration changes will take effect after the restart.',
  ...
  'settings.page.appearance.description': 'Customize how MittrCraft looks and feels.',
  ...
  'settings.mittrcraft.tunnel.title': 'External Tunnel',
  'settings.mittrcraft.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.mittrcraft.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.mittrcraft.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.mittrcraft.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.mittrcraft.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.mittrcraft.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.mittrcraft.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.mittrcraft.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.mittrcraft.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.mittrcraft.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.mittrcraft.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.mittrcraft.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.mittrcraft.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.mittrcraft.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.mittrcraft.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.mittrcraft.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.mittrcraft.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.mittrcraft.tunnel.field.provider': 'Provider',
  'settings.mittrcraft.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.mittrcraft.tunnel.field.tunnelType': 'Tunnel type',
  'settings.mittrcraft.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.mittrcraft.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.mittrcraft.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.mittrcraft.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.mittrcraft.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.mittrcraft.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.mittrcraft.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.mittrcraft.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.mittrcraft.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.mittrcraft.tunnel.field.configurationFile': 'Configuration file',
  'settings.mittrcraft.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.mittrcraft.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.mittrcraft.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.mittrcraft.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.mittrcraft.tunnel.field.connectLink': 'Connect link',
  'settings.mittrcraft.tunnel.field.expires': 'Expires',
  'settings.mittrcraft.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.mittrcraft.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.mittrcraft.tunnel.actions.saveToken': 'Save token',
  'settings.mittrcraft.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.mittrcraft.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.mittrcraft.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.mittrcraft.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.mittrcraft.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.mittrcraft.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.mittrcraft.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.mittrcraft.tunnel.actions.stopping': 'Stopping...',
  'settings.mittrcraft.tunnel.actions.newConnectLink': 'New connect link',
  'settings.mittrcraft.tunnel.actions.copied': 'Copied',
  'settings.mittrcraft.tunnel.actions.retry': 'Retry',
  'settings.mittrcraft.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.mittrcraft.tunnel.option.mode.quick.label': 'Quick',
  'settings.mittrcraft.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.mittrcraft.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.mittrcraft.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.mittrcraft.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.mittrcraft.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.mittrcraft.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.mittrcraft.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.mittrcraft.tunnel.state.loading': 'Loading',
  'settings.mittrcraft.tunnel.state.expired': 'Expired',
  'settings.mittrcraft.tunnel.state.revoked': 'Revoked',
  'settings.mittrcraft.tunnel.state.inactive': 'Inactive',
  'settings.mittrcraft.tunnel.state.noExpiry': 'No expiry',
  'settings.mittrcraft.tunnel.state.never': 'Never',
  'settings.mittrcraft.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.mittrcraft.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.mittrcraft.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.mittrcraft.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.mittrcraft.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.mittrcraft.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/mittrcraft/cloudflare-managed-remote-tunnels.json.',
  'settings.mittrcraft.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.mittrcraft.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.mittrcraft.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.mittrcraft.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.mittrcraft.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.mittrcraft.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.mittrcraft.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.mittrcraft.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.mittrcraft.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.mittrcraft.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.mittrcraft.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.mittrcraft.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.mittrcraft.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.mittrcraft.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.mittrcraft.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.mittrcraft.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.mittrcraft.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.mittrcraft.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.mittrcraft.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.mittrcraft.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.mittrcraft.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.mittrcraft.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.mittrcraft.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.mittrcraft.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.mittrcraft.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.mittrcraft.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other MittrCraft servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another MittrCraft server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another MittrCraft server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid MittrCraft connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so MittrCraft Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the MittrCraft app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through MittrCraft Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the MittrCraft app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether MittrCraft should start the server for you, or connect to one that is already running.',
  ...
  'settings.mittrcraft.about.title': 'About MittrCraft',
  'settings.mittrcraft.about.field.version': 'Version',
  'settings.mittrcraft.about.field.openCodeVersion': 'MittrCraft Engine version',
  'settings.mittrcraft.about.field.instanceUrls': 'Instance URLs',
  'settings.mittrcraft.about.field.applicationUrl': 'Application',
  'settings.mittrcraft.about.field.tunnelUrl': 'Tunnel',
  'settings.mittrcraft.about.state.checking': 'Checking...',
  'settings.mittrcraft.about.state.upToDate': 'Up to date',
  'settings.mittrcraft.about.state.unknown': 'unknown',
  'settings.mittrcraft.about.actions.checkUpdates': 'Check updates',
  'settings.mittrcraft.about.actions.update': 'Update',
  'settings.mittrcraft.about.actions.updateToVersion': 'Update to {version}',
  'settings.mittrcraft.about.actions.checkForUpdates': 'Check for updates',
  'settings.mittrcraft.about.actions.signOutMittr': 'Sign out of Mittr',
  'settings.mittrcraft.about.toast.signOutFailed': 'Could not sign out of Mittr',
  'settings.mittrcraft.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Saved to disk. Restart your connected MittrCraft Engine server to apply the changes.',
  ...
  'settings.agents.page.permissionsEditor.toast.savedRestartRequired': 'Permissions saved — restart the MittrCraft Engine server to apply',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. MittrCraft Engine also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.behavior.page.systemPromptOptimization.enableAria': 'Optimize MittrCraft Engine system prompt size',
  'settings.behavior.page.systemPromptOptimization.info': 'Reduces the system prompt by an estimated 40% for the build and plan agents. Other agents are not changed. This can remove custom definitions that override build or plan, so do not enable it for workflows that customize those agents. Restarting MittrCraft Engine applies the change.',
  'settings.behavior.page.systemPromptOptimization.restarting': 'Restarting MittrCraft Engine to apply system prompt optimization…',
  ...
  'settings.skills.location.option.userOpencode.label': 'User / MittrCraft Engine',
  'settings.skills.location.option.userOpencode.description': 'Global MittrCraft Engine config location',
  'settings.skills.location.option.projectOpencode.label': 'Project / MittrCraft Engine',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. MittrCraft will scan it for folders containing',
  ...
  'settings.mittrcraft.passkeys.field.currentDevice': 'Current device',
  'settings.mittrcraft.passkeys.actions.add': 'Add passkey',
  'settings.mittrcraft.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.mittrcraft.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.mittrcraft.passkeys.actions.signingOut': 'Signing out…',
  'settings.mittrcraft.passkeys.actions.removing': 'Removing…',
  'settings.mittrcraft.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.mittrcraft.passkeys.state.loading': 'Loading passkeys…',
  'settings.mittrcraft.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.mittrcraft.passkeys.item.lastUsed': 'Last used {time}',
  'settings.mittrcraft.passkeys.item.added': 'Added {time}',
  'settings.mittrcraft.passkeys.time.neverUsed': 'Never used',
  'settings.mittrcraft.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.mittrcraft.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.mittrcraft.passkeys.toast.added': 'Passkey added',
  'settings.mittrcraft.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.mittrcraft.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.mittrcraft.passkeys.toast.removed': 'Passkey removed',
  'settings.mittrcraft.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.mittrcraft.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.mittrcraft.sessionRetention.title': 'Session Retention',
  'settings.mittrcraft.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.mittrcraft.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.mittrcraft.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.mittrcraft.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.mittrcraft.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.mittrcraft.sessionRetention.field.days': 'days',
  'settings.mittrcraft.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.mittrcraft.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.mittrcraft.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.mittrcraft.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.mittrcraft.sessionRetention.action.archive': 'Archive',
  'settings.mittrcraft.sessionRetention.action.delete': 'Delete',
  'settings.mittrcraft.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.mittrcraft.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.mittrcraft.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.mittrcraft.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.mittrcraft.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.mittrcraft.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.mittrcraft.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.mittrcraft.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.mittrcraft.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.mittrcraft.desktopNetwork.title': 'Desktop Network Access',
  'settings.mittrcraft.desktopNetwork.field.windowControlsPosition': 'Window controls position',
  'settings.mittrcraft.desktopNetwork.field.windowControlsPositionDescription': 'Choose where minimize, maximize, and close buttons appear. Defaults to the right.',
  'settings.mittrcraft.desktopNetwork.field.windowControlsPositionAria': 'Window controls position',
  'settings.mittrcraft.desktopNetwork.option.windowControlsLeft': 'Left',
  'settings.mittrcraft.desktopNetwork.option.windowControlsRight': 'Right',
  'settings.mittrcraft.desktopNetwork.field.windowControls': 'Window controls',
  'settings.mittrcraft.desktopNetwork.field.windowControlsStyle': 'Style',
  'settings.mittrcraft.desktopNetwork.field.windowControlsStyleAria': 'Window controls style',
  'settings.mittrcraft.desktopNetwork.option.windowControlsClassic': 'Classic',
  'settings.mittrcraft.desktopNetwork.option.windowControlsTrafficLights': 'Traffic lights',
  'settings.mittrcraft.desktopNetwork.field.launchAtLoginAria': 'Start MittrCraft at login',
  'settings.mittrcraft.desktopNetwork.field.launchAtLogin': 'Start MittrCraft when you log in',
  'settings.mittrcraft.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.mittrcraft.desktopNetwork.field.macMenuBarAria': 'Show MittrCraft in the macOS menu bar',
  'settings.mittrcraft.desktopNetwork.field.macMenuBar': 'Show MittrCraft in the menu bar',
  'settings.mittrcraft.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, MittrCraft does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.mittrcraft.desktopNetwork.field.minimizeToTrayAria': 'Close MittrCraft to the system tray',
  'settings.mittrcraft.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.mittrcraft.desktopNetwork.field.minimizeToTrayDescription': 'Keeps MittrCraft running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.mittrcraft.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while MittrCraft is running',
  'settings.mittrcraft.desktopNetwork.field.keepAwake': 'Keep computer awake while MittrCraft is running',
  'settings.mittrcraft.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.mittrcraft.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.mittrcraft.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.mittrcraft.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.mittrcraft.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.mittrcraft.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.mittrcraft.desktopPassword.actions.showPassword': 'Show password',
  'settings.mittrcraft.desktopPassword.actions.hidePassword': 'Hide password',
  'settings.mittrcraft.desktopPassword.field.password': 'Desktop UI Password',
  'settings.mittrcraft.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.mittrcraft.desktopPassword.field.passwordDescription': 'MittrCraft asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.mittrcraft.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.mittrcraft.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.mittrcraft.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.mittrcraft.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.mittrcraft.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.mittrcraft.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.mittrcraft.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.mittrcraft.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.mittrcraft.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.mittrcraft.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.mittrcraft.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.mittrcraft.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.mittrcraft.opencodeCli.title': 'MittrCraft Engine',
  'settings.mittrcraft.tools.title': 'MittrCraft Tools',
  'settings.mittrcraft.tools.field.agentControlTool': 'Agent control tool',
  'settings.mittrcraft.tools.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.mittrcraft.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after MittrCraft Engine restarts.',
  'settings.mittrcraft.tools.field.agentWebTool': 'MittrCraft Web tool',
  'settings.mittrcraft.tools.field.agentWebToolAria': 'Enable the MittrCraft Web tool',
  'settings.mittrcraft.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in MittrCraft\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after MittrCraft Engine restarts.',
  ...
  'settings.mittrcraft.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.mittrcraft.opencodeCli.tooltipSuffix': 'binary.',
  'settings.mittrcraft.opencodeCli.field.binaryPath': 'MittrCraft Engine Binary Path',
  'settings.mittrcraft.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.mittrcraft.opencodeCli.actions.browseAria': 'Browse for MittrCraft Engine binary path',
  'settings.mittrcraft.opencodeCli.actions.browse': 'Browse',
  'settings.mittrcraft.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.mittrcraft.opencodeCli.actions.restartingOpenCode': 'Restarting MittrCraft Engine…',
  'settings.mittrcraft.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.mittrcraft.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.mittrcraft.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.mittrcraft.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.mittrcraft.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.mittrcraft.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.mittrcraft.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.mittrcraft.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.mittrcraft.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.mittrcraft.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.mittrcraft.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.mittrcraft.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.mittrcraft.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.mittrcraft.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.mittrcraft.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.mittrcraft.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.mittrcraft.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.mittrcraft.keyboardShortcuts.action.add_selection_to_chat.label': 'Add selection to chat',
  'settings.mittrcraft.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.mittrcraft.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle context panel',
  'settings.mittrcraft.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open Git surface',
  'settings.mittrcraft.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open Files surface',
  'settings.mittrcraft.keyboardShortcuts.action.switch_context_surface.label': 'Switch context panel surface',
  'settings.mittrcraft.keyboardShortcuts.action.switch_context_surface.suffix': ' + 1…0',
  'settings.mittrcraft.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.mittrcraft.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.mittrcraft.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.mittrcraft.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.mittrcraft.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.mittrcraft.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.mittrcraft.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.mittrcraft.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.mittrcraft.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.mittrcraft.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.mittrcraft.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.mittrcraft.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.mittrcraft.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.mittrcraft.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.mittrcraft.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open MittrCraft there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'MittrCraft on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how MittrCraft should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote MittrCraft server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote MittrCraft UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How MittrCraft should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingMittrCraft': 'Installing MittrCraft',
  'settings.remoteInstances.page.phase.updatingMittrCraft': 'Updating MittrCraft',
  ...
  'settings.mittrcraft.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.mittrcraft.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.mittrcraft.worktrees.setup.title': 'Setup commands',
  'settings.mittrcraft.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.mittrcraft.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.mittrcraft.worktrees.setup.loading': 'Loading...',
  'settings.mittrcraft.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.mittrcraft.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.mittrcraft.worktrees.setup.addCommand': 'Add command',
  'settings.mittrcraft.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.mittrcraft.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.mittrcraft.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.mittrcraft.worktrees.list.title': 'Existing worktrees',
  'settings.mittrcraft.worktrees.list.tooltip': 'Deleting a worktree also removes its linked sessions.',
  'settings.mittrcraft.worktrees.list.loading': 'Loading worktrees...',
  'settings.mittrcraft.worktrees.list.empty': 'No worktrees found for this project',
  'settings.mittrcraft.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.mittrcraft.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.sidebar.empty.description': 'Check your MittrCraft Engine configuration',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'Check your MittrCraft Engine configuration',
  ...
  'settings.providers.page.custom.description': 'Add an OpenAI-compatible provider with a base URL, credentials, and model list. Saved to MittrCraft Engine config so it works in chat like any other provider.',
  ...
  'settings.providers.page.custom.field.providerID.info': 'Lowercase letters, numbers, hyphens, and underscores. Used as the MittrCraft Engine provider id.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored by the engine, not by MittrCraft. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to the engine and never stored by MittrCraft.',
  ...
  'settings.mcp.page.status.description.awaitingRestart': 'This server is saved but not applied yet. Use Apply & Restart to load it into MittrCraft Engine — connect and authorization become available after that.',
  'settings.mcp.page.status.description.connected': 'Connected and ready for MittrCraft Engine to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'MittrCraft Engine could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForOpenCode': 'Waiting for MittrCraft Engine to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use MittrCraft Engine\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let MittrCraft Engine infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'MittrCraft Engine will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but MittrCraft Engine reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but MittrCraft Engine reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. MittrCraft Engine reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. MittrCraft Engine reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but MittrCraft Engine reload failed',
  ...
  'settings.mcp.page.toast.openCodeReloadFailedAfterCallbackSave': 'MittrCraft Engine reload failed after saving the browser callback URL',
  ...
  'settings.mittrcraft.defaults.title': 'Session Defaults',
  'settings.mittrcraft.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.mittrcraft.defaults.summaryOpenCodeDefault': 'MittrCraft Engine agent default',
  'settings.mittrcraft.defaults.field.defaultModel': 'Default Model',
  'settings.mittrcraft.defaults.field.defaultThinking': 'Default Thinking',
  'settings.mittrcraft.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.mittrcraft.defaults.field.defaultAgent': 'Default Agent',
  'settings.mittrcraft.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.mittrcraft.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.mittrcraft.defaults.smallModel.title': 'Small Model',
  'settings.mittrcraft.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.mittrcraft.defaults.smallModel.useDefault': 'Use default small model',
  'settings.mittrcraft.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.mittrcraft.defaults.smallModel.overrideModel': 'Override model',
  'settings.mittrcraft.defaults.walkthroughModel.title': 'Changes Walkthrough Model',
  ...
  'settings.mittrcraft.defaults.walkthroughModel.overrideModel': 'Walkthrough model',
  'settings.mittrcraft.defaults.walkthroughModel.usesSmallModel': 'Small model',
  'settings.mittrcraft.defaults.field.openFilesPreviewAria': 'Open previewable files in preview mode',
  'settings.mittrcraft.defaults.field.openFilesPreview': 'Open previewable files in preview mode',
  'settings.mittrcraft.defaults.option.default': 'Default',
  'settings.mittrcraft.defaults.option.defaultLowercase': 'default',
  'settings.mittrcraft.git.title': 'Git Preferences',
  'settings.mittrcraft.git.changesViewTitle': 'Changes View',
  'settings.mittrcraft.git.changesViewAria': 'Git changes view mode',
  'settings.mittrcraft.git.option.flatList': 'Flat List',
  'settings.mittrcraft.git.option.treeView': 'Tree View',
  'settings.mittrcraft.git.optionAria': 'Git changes view mode: {option}',
  'settings.mittrcraft.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.mittrcraft.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.mittrcraft.git.showGitignoredAria': 'Display gitignored files',
  'settings.mittrcraft.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize MittrCraft',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if MittrCraft auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from MittrCraft.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the MittrCraft server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the MittrCraft server (Kokoro, English). The model downloads automatically; no API key needed.',
  ...
  'settings.mittrcraft.visual.section.colorMode': 'Color Mode',
  'settings.mittrcraft.visual.section.colorModeAndTheme': 'Color mode & Theme',
  'settings.mittrcraft.visual.section.mobileLayout': 'Mobile Layout',
  'settings.mittrcraft.visual.option.mobileLayout.default': 'Old',
  'settings.mittrcraft.visual.option.mobileLayout.new': 'New',
  'settings.mittrcraft.visual.section.localization': 'Localization',
  'settings.mittrcraft.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.mittrcraft.visual.section.densityAndType': 'Density & type',
  'settings.mittrcraft.visual.section.sidebar': 'Sidebar',
  'settings.mittrcraft.visual.field.sidebarSide': 'Sidebar position',
  'settings.mittrcraft.visual.field.sidebarSideHint': 'Choose which edge of the window the session list sits on.',
  'settings.mittrcraft.visual.field.sidebarSideAria': 'Sidebar position',
  'settings.mittrcraft.visual.option.sidebarSide.left': 'Left',
  'settings.mittrcraft.visual.option.sidebarSide.right': 'Right',
  'settings.mittrcraft.visual.section.appInstall': 'App install',
  'settings.mittrcraft.visual.section.navigation': 'Navigation',
  'settings.mittrcraft.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.mittrcraft.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.mittrcraft.visual.section.chatDisplay': 'Display',
  'settings.mittrcraft.visual.section.chatMessageOptions': 'Message options',
  'settings.mittrcraft.visual.section.chatFeatures': 'Features',
  'settings.mittrcraft.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.mittrcraft.visual.section.activityDefault': 'Activity Default',
  'settings.mittrcraft.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.mittrcraft.visual.section.showToolsOpenedByDefault': 'Show tools opened by default',
  'settings.mittrcraft.visual.section.sessionAssistance': 'Session Assistance',
  'settings.mittrcraft.visual.section.reasoning': 'Reasoning',
  'settings.mittrcraft.visual.section.messageAppearance': 'Message Appearance',
  'settings.mittrcraft.visual.section.toolsAndFiles': 'Tools & Files',
  'settings.mittrcraft.visual.section.composer': 'Composer',
  'settings.mittrcraft.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.mittrcraft.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.mittrcraft.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.mittrcraft.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.mittrcraft.visual.section.diffLayout': 'Diff Layout',
  'settings.mittrcraft.visual.section.diffLayoutAria': 'Diff layout',
  'settings.mittrcraft.visual.section.privacy': 'Privacy',
  'settings.mittrcraft.visual.field.lightTheme': 'Light Theme',
  'settings.mittrcraft.visual.field.darkTheme': 'Dark Theme',
  'settings.mittrcraft.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.mittrcraft.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.mittrcraft.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.mittrcraft.visual.field.timeFormat': 'Time Format',
  'settings.mittrcraft.visual.field.weekStartsOn': 'Week Starts On',
  'settings.mittrcraft.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.mittrcraft.visual.field.selectWeekStartAria': 'Select week start',
  'settings.mittrcraft.visual.actions.reloadThemes': 'Reload themes',
  'settings.mittrcraft.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.mittrcraft.visual.field.dockBadge': 'Dock badge',
  'settings.mittrcraft.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.mittrcraft.visual.actions.saveAndRestart': 'Save & restart',
  'settings.mittrcraft.visual.actions.restarting': 'Restarting…',
  'settings.mittrcraft.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.mittrcraft.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/mittrcraft/themes/',
  'settings.mittrcraft.visual.field.installAppName': 'Install App Name',
  'settings.mittrcraft.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.mittrcraft.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.mittrcraft.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.mittrcraft.visual.field.installOrientation': 'Install Orientation',
  'settings.mittrcraft.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.mittrcraft.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.mittrcraft.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.mittrcraft.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.mittrcraft.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.mittrcraft.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.mittrcraft.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.mittrcraft.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.mittrcraft.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.mittrcraft.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.mittrcraft.visual.field.interfaceFont': 'Interface Font',
  'settings.mittrcraft.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.mittrcraft.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.mittrcraft.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.mittrcraft.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.mittrcraft.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.mittrcraft.visual.field.terminalShell': 'Terminal Shell',
  'settings.mittrcraft.visual.field.terminalShellAria': 'Select terminal shell',
  'settings.mittrcraft.visual.field.terminalShellHint': 'Restart the terminal to apply this change to the current session.',
  'settings.mittrcraft.visual.field.terminalLoginShell': 'Start as login shell',
  'settings.mittrcraft.visual.option.terminalShell.auto': 'Auto',
  'settings.mittrcraft.visual.field.editorFontSize': 'Editor Font Size',
  'settings.mittrcraft.visual.field.codeFont': 'Code Font',
  'settings.mittrcraft.visual.field.selectCodeFontAria': 'Select code font',
  'settings.mittrcraft.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.mittrcraft.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.mittrcraft.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.mittrcraft.visual.field.spacingDensity': 'Spacing Density',
  'settings.mittrcraft.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.mittrcraft.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.mittrcraft.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.mittrcraft.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.mittrcraft.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.mittrcraft.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.mittrcraft.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.mittrcraft.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.mittrcraft.visual.option.fileEditorKeymap.default': 'Default',
  'settings.mittrcraft.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.mittrcraft.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.mittrcraft.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.mittrcraft.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.mittrcraft.visual.field.bash': 'Bash',
  'settings.mittrcraft.visual.field.editTools': 'Edit tools',
  'settings.mittrcraft.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  ...
  'settings.mittrcraft.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.mittrcraft.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.mittrcraft.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.mittrcraft.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.mittrcraft.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.mittrcraft.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.mittrcraft.visual.goal.sectionTitle': 'Goal',
  'settings.mittrcraft.visual.goal.budgetLabel': 'Default token budget',
  'settings.mittrcraft.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.mittrcraft.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.mittrcraft.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.mittrcraft.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.mittrcraft.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.mittrcraft.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.mittrcraft.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.mittrcraft.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.mittrcraft.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.mittrcraft.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.mittrcraft.visual.field.autoSaveEnabledAria': 'Auto-save files',
  'settings.mittrcraft.visual.field.autoSaveEnabled': 'Auto-save files',
  'settings.mittrcraft.visual.field.autoSaveEnabledInfo': 'Automatically save file edits after you stop typing. Disable to require manual save.',
  'settings.mittrcraft.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.mittrcraft.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.mittrcraft.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.mittrcraft.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.mittrcraft.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.mittrcraft.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.mittrcraft.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.mittrcraft.visual.field.allowPromptingSubagentSessionsAria': 'Allow prompting subagent sessions',
  'settings.mittrcraft.visual.field.allowPromptingSubagentSessions': 'Allow Prompting Subagent Sessions',
  'settings.mittrcraft.visual.field.draftStartersVisible': 'Show Starters on New Session Screen',
  'settings.mittrcraft.visual.field.draftStartersVisibleAria': 'Show starters on the new session screen',
  'settings.mittrcraft.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.mittrcraft.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.mittrcraft.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.mittrcraft.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.mittrcraft.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.mittrcraft.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.mittrcraft.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.mittrcraft.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.mittrcraft.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.mittrcraft.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.mittrcraft.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.mittrcraft.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.mittrcraft.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.mittrcraft.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.mittrcraft.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.mittrcraft.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.mittrcraft.visual.option.themeMode.system': 'System',
  'settings.mittrcraft.visual.option.themeMode.system.description': 'Follow system setting',
  'settings.mittrcraft.visual.option.themeMode.light': 'Light',
  'settings.mittrcraft.visual.option.themeMode.light.description': 'Always use light appearance',
  'settings.mittrcraft.visual.option.themeMode.dark': 'Dark',
  'settings.mittrcraft.visual.option.themeMode.dark.description': 'Always use dark appearance',
  'settings.mittrcraft.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.mittrcraft.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.mittrcraft.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.mittrcraft.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.mittrcraft.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.mittrcraft.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.mittrcraft.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.mittrcraft.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.mittrcraft.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.mittrcraft.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.mittrcraft.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.mittrcraft.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.mittrcraft.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.mittrcraft.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.mittrcraft.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.mittrcraft.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.mittrcraft.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.mittrcraft.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.mittrcraft.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.mittrcraft.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.mittrcraft.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.mittrcraft.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.mittrcraft.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.mittrcraft.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.mittrcraft.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.mittrcraft.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.mittrcraft.visual.option.chatRenderMode.live.label': 'Live',
  'settings.mittrcraft.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.mittrcraft.visual.option.messageTransport.auto.label': 'Auto',
  'settings.mittrcraft.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.mittrcraft.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.mittrcraft.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.mittrcraft.visual.option.messageTransport.sse.label': 'SSE',
  'settings.mittrcraft.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.mittrcraft.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.mittrcraft.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.mittrcraft.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.mittrcraft.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.mittrcraft.visual.option.timeFormat.auto.label': 'Auto',
  'settings.mittrcraft.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.mittrcraft.visual.option.timeFormat.24h.label': '24-hour',
  'settings.mittrcraft.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.mittrcraft.visual.option.timeFormat.12h.label': '12-hour',
  'settings.mittrcraft.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.mittrcraft.visual.option.weekStart.auto.label': 'Auto',
  'settings.mittrcraft.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.mittrcraft.visual.option.weekStart.monday.label': 'Monday',
  'settings.mittrcraft.visual.option.weekStart.sunday.label': 'Sunday',
