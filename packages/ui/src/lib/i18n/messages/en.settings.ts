...
export const settingsDict = {
  ...
  'settings.openchamber.about.title': 'About MittrCraft',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start MittrCraft at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start MittrCraft when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show MittrCraft in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show MittrCraft in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, MittrCraft does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Close MittrCraft to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps MittrCraft running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while MittrCraft is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while MittrCraft is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'MittrCraft asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.tools.title': 'MittrCraft Tools',
...
=======
  'settings.openchamber.tools.field.agentWebTool': 'MittrCraft Web tool',
  'settings.openchamber.tools.field.agentWebToolAria': 'Enable the MittrCraft Web tool',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in MittrCraft\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
>>>>>>> 245ff364 (feat: implement Active Directory and Entra ID authentication support with session management updates)
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing MittrCraft',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating MittrCraft',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by MittrCraft. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by MittrCraft.',
