...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. Mittr Craft never scans browser cookie storage.',
  ...
  'settings.window.description': 'Mittr Craft settings window.',
  ...
  'settings.page.appearance.description': 'Customize how Mittr Craft looks and feels.',
  ...
  'settings.remoteInstances.direct.title': 'Other Mittr Craft servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another Mittr Craft server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Mittr Craft server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Mittr Craft connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Mittr Craft Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the Mittr Craft app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through Mittr Craft Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the Mittr Craft app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Mittr Craft should start the server for you, or connect to one that is already running.',
  ...
  'settings.openchamber.about.title': 'About Mittr Craft',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Mittr Craft will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start Mittr Craft at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start Mittr Craft when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show Mittr Craft in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show Mittr Craft in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, Mittr Craft does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Close Mittr Craft to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps Mittr Craft running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while Mittr Craft is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while Mittr Craft is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Mittr Craft asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.tools.title': 'Mittr Craft Tools',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Mittr Craft Web tool',
  'settings.openchamber.tools.field.agentWebToolAria': 'Enable the Mittr Craft Web tool',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in Mittr Craft\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Mittr Craft there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Mittr Craft on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Mittr Craft should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote Mittr Craft server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Mittr Craft UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Mittr Craft should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing Mittr Craft',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating Mittr Craft',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by Mittr Craft. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Mittr Craft.',
  ...
  'settings.github.page.flow.title': 'Authorize Mittr Craft',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Mittr Craft auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Mittr Craft.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the Mittr Craft server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the Mittr Craft server (Kokoro, English). The model downloads automatically; no API key needed.',
