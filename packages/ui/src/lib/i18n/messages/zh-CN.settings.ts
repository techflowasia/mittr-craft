...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.about.title': '关于 MittrCraft',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登录时启动 MittrCraft',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登录时启动 MittrCraft',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在后台启动应用且不打开窗口。可通过桌面状态图标打开。',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': '在 macOS 菜单栏中显示 MittrCraft',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '在菜单栏中显示 MittrCraft',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '需要重启应用。关闭后，MittrCraft 不会创建菜单栏项目，也不会运行相关的会话、审批和用量更新。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '将 MittrCraft 关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '关闭主窗口时，让 MittrCraft 继续在系统托盘中运行；最小化仍会将窗口保留在任务栏。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'MittrCraft 运行时保持电脑唤醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'MittrCraft 运行时保持电脑唤醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'MittrCraft 会在重启后要求输入密码，之后在登录会话过期时再次要求：12 小时后，或选择“信任此设备”后 7 天。留空可关闭登录。',
  ...
  'settings.openchamber.tools.title': 'MittrCraft 工具',
  ...
  'settings.openchamber.tools.field.agentMemoryToolAria': '启用智能体记忆工具',
  'settings.openchamber.tools.field.agentMemoryToolInfo': '让智能体跨会话保留所学内容，并分别存储关于你的信息和关于各项目的信息。会话会获得已保存的标题，以便智能体在相关时读取条目。关闭后会移除该工具、记忆标签页和会话索引。在 OpenCode 重启后生效。',
  ...
  'settings.providers.page.custom.field.apiKey.info': '保存在 OpenCode 认证中，而非 MittrCraft。使用 {env:VAR_NAME} 可从环境变量读取密钥。',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '密钥将直接发送给 OpenCode，不会被 MittrCraft 存储。',
