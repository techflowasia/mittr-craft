...
export const dict: Record<I18nKey, string> = {
  ...
  'opencodeUpdate.toast.actions.reload': '重新載入 MittrCraft Engine',
  'opencodeUpdate.toast.upgrading.title': '正在更新 MittrCraft Engine...',
  'opencodeUpdate.toast.upgrading.description': '請保持 MittrCraft 開啟。',
  ...
  'opencodeUpdate.toast.failed.title': '無法更新 MittrCraft Engine',
  'opencodeUpdate.toast.failed.description': 'MittrCraft Engine 升級失敗。',
  'opencodeUpdate.toast.reload.message': '正在重新啟動 MittrCraft Engine...',
