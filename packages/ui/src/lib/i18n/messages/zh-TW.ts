...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 MittrCraft 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'MittrCraft 已安裝',
  ...
  'mobile.connect.welcome.title': '連線至 MittrCraft',
  ...
  'mobile.connect.password.placeholder': 'MittrCraft 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 MittrCraft 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 MittrCraft Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 MittrCraft 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 MittrCraft。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 MittrCraft，但與此應用程式版本不相容。請更新伺服器上的 MittrCraft 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 MittrCraft 伺服器與此應用程式版本不相容。請更新伺服器上的 MittrCraft 後重試。',
  ...
  "sessions.myWork.dialog.projectMenu.label": "要在哪個專案中開始？",
  "sessions.myWork.dialog.projectMenu.empty": "請先新增專案",
  ...
  'sessions.sidebar.footer.actions.aboutMittrCraft': '關於 MittrCraft',
  ...
  'sessions.sidebar.footer.profile.details.email': '電子郵件',
  'sessions.sidebar.footer.profile.details.department': '部門',
  'sessions.sidebar.footer.profile.details.jobTitle': '職稱',
  'sessions.sidebar.footer.profile.details.groups': '群組',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 MittrCraft 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 執行在 MittrCraft 所在的機器上，無法與其建立連線。這裡不會顯示你本機上的任何內容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 MittrCraft 的那台機器上。要開啟它們需要桌面應用程式。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 MittrCraft 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 MittrCraft 中編輯。請下載後使用其他應用程式開啟。',
  ...
  'contextSidebar.activity.title': '活動',
  'contextSidebar.activity.subagent': '子代理',
  'contextSidebar.activity.subagentUntitled': '未命名子代理',
  'contextSidebar.activity.elapsed': '耗時 {duration}',
  'contextSidebar.activity.tokens': '輸入 {input} · 輸出 {output}',
  'contextSidebar.activity.step': '第 {index} 步，共 {total} 步',
  'contextSidebar.activity.working': '進行中',
  'contextSidebar.activity.modelTokens': '{model} · {tokens} 個權杖',
  'contextSidebar.activity.empty': '尚無活動',
  'contextSidebar.rawMessages.roleUser': '使用者',
  'contextSidebar.rawMessages.column.tokens': '輸入 / 輸出',
  'contextSidebar.rawMessages.tokensAria': '輸入 {input} 個權杖，輸出 {output} 個權杖',
  ...
  'chat.recap.label': '回顧：',
  'chat.goal.dialog.titleCreate': '設定 Mittr 目標',
  'chat.goal.dialog.titleManage': 'Mittr 目標',
  ...
  'chat.goal.button.armAria': '用下一則訊息開始 Mittr 目標',
  ...
  'chat.goal.criteria.title': '完成標準',
  'chat.goal.criteria.progress': '已完成 {met}/{total}',
  'chat.goal.criteria.pendingContract': '「完成」的標準會在第一輪之後確定。',
  'chat.goal.criteria.status.met': '已達成',
  'chat.goal.criteria.status.missing': '尚未達成',
  'chat.goal.criteria.status.needsPerson': '需要你處理',
  'chat.goal.criteria.status.pending': '尚未檢查',
  'chat.goal.criteria.checkedBy.script': '由指令碼檢查',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'MittrCraft 需要存取此資料夾。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 MittrCraft 狀態、MittrCraft Engine 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 MittrCraft',
  ...
  'header.actions.openAppMenu': 'MittrCraft 選單',
  'header.actions.openAppMenuAria': '開啟 MittrCraft 選單',
  ...
  'chat.emptyState.opencodeUnreachable': '無法連線 MittrCraft Engine',
  ...
  'openCodeStatusDialog.title': 'MittrCraft Engine 狀態',
  'openCodeStatusDialog.description': '查看目前 MittrCraft Engine 狀態與診斷資訊。',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 MittrCraft，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 MittrCraft',
  ...
  'sessionAuth.locked.microsoftDescription': '請使用您的 Microsoft 帳戶登入。',
  'sessionAuth.locked.microsoftBrowserDescription': '可在瀏覽器中使用 Microsoft 登入。',
  'sessionAuth.actions.signInWithMicrosoft': '使用 Microsoft 登入',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 MittrCraft 伺服器之間切換',
  ...
  'multiRun.window.description': 'MittrCraft 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 MittrCraft',
  ...
  'onboarding.localSetup.title': '設定 MittrCraft Engine',
  'onboarding.localSetup.description': '安裝 MittrCraft Engine 以繼續。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '選擇 MittrCraft Engine 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'MittrCraft Engine 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 MittrCraft Engine。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 MittrCraft 未自動偵測到 MittrCraft Engine，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'MittrCraft Engine 是 MittrCraft 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'MittrCraft Engine 文件',
  'onboarding.localSetup.docs.default': 'MittrCraft Engine 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 MittrCraft Engine 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 MittrCraft Engine',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 MittrCraft Engine 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 MittrCraft 設定並重新載入 MittrCraft Engine 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 MittrCraft Engine。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 MittrCraft 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 MittrCraft 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 MittrCraft。請確認位址是否指向 MittrCraft 伺服器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '伺服器無法連線。請檢查網路連線並確認伺服器位址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 MittrCraft Engine 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'MittrCraft Engine 無法啟動或未安裝。請安裝 MittrCraft Engine，或改為連接遠端伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 MittrCraft。請確認位址是否指向 MittrCraft 伺服器。',
  ...
  'startup.initRecovery.description': 'MittrCraft 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：mittrcraft update',
  ...
  'mittrCraftLogo.aria.logo': 'MittrCraft 標誌',
