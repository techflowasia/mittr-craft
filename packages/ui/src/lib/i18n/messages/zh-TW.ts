...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 MittrCraft',
  ...
  'aboutDialog.openChamberVersionLabel': 'MittrCraft 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 MittrCraft 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 MittrCraft 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 MittrCraft 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 MittrCraft 設定並重新載入 OpenCode 設定。',
  ...
  'openChamberLogo.aria.logo': 'MittrCraft 標誌',
