...
export const dict: Record<I18nKey, string> = {
  ...
  'opencodeUpdate.toast.available.title': 'MittrCraft Engine 更新',
  ...
  'opencodeUpdate.toast.actions.reload': '重载 MittrCraft Engine',
  'opencodeUpdate.toast.upgrading.title': '正在更新 MittrCraft Engine...',
  'opencodeUpdate.toast.upgrading.description': '请保持 MittrCraft 打开。',
  'opencodeUpdate.toast.updated.title': 'MittrCraft Engine 已更新',
  'opencodeUpdate.toast.updated.description': '更新已安装。',
  'opencodeUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安装。',
  'opencodeUpdate.toast.failed.title': '无法更新 MittrCraft Engine',
  'opencodeUpdate.toast.failed.description': 'MittrCraft Engine 升级失败。',
  'opencodeUpdate.toast.reload.message': '正在重启 MittrCraft Engine...',
