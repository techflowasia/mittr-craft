...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 MittrCraft 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'MittrCraft 已安装',
  ...
  'mobile.connect.welcome.title': '连接到 MittrCraft',
  ...
  'mobile.connect.password.placeholder': 'MittrCraft 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 MittrCraft 服务器。',
  ...
  "sessions.myWork.dialog.projectMenu.label": "在哪个项目中开始？",
  "sessions.myWork.dialog.projectMenu.empty": "请先添加项目",
  ...
  'sessions.sidebar.footer.actions.aboutMittrCraft': '关于 MittrCraft',
  ...
  'sessions.sidebar.footer.profile.details.email': '电子邮件',
  'sessions.sidebar.footer.profile.details.department': '部门',
  'sessions.sidebar.footer.profile.details.jobTitle': '职位',
  'sessions.sidebar.footer.profile.details.groups': '组',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此应用连接的 MittrCraft 服务器没有响应 walkthrough API，说明它比应用更旧。请将服务器升级到 1.18 或更高版本后刷新。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 运行在 MittrCraft 所在的机器上，无法与其建立连接。这里不会显示你本机上的任何内容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它们运行在托管 MittrCraft 的那台机器上。要打开它们需要桌面应用。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 MittrCraft 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 MittrCraft 中编辑。请下载后使用其他应用打开。',
  ...
  'contextSidebar.activity.title': '活动',
  'contextSidebar.activity.subagent': '子代理',
  'contextSidebar.activity.subagentUntitled': '未命名子代理',
  'contextSidebar.activity.elapsed': '耗时 {duration}',
  'contextSidebar.activity.tokens': '输入 {input} · 输出 {output}',
  'contextSidebar.activity.step': '第 {index} 步，共 {total} 步',
  'contextSidebar.activity.working': '进行中',
  'contextSidebar.activity.modelTokens': '{model} · {tokens} 个令牌',
  'contextSidebar.activity.empty': '暂无活动',
  'contextSidebar.rawMessages.roleUser': '用户',
  'contextSidebar.rawMessages.column.tokens': '输入 / 输出',
  'contextSidebar.rawMessages.tokensAria': '输入 {input} 个令牌，输出 {output} 个令牌',
  ...
  'chat.recap.label': '回顾：',
  'chat.goal.dialog.titleCreate': '设置 Mittr 目标',
  'chat.goal.dialog.titleManage': 'Mittr 目标',
  ...
  'chat.goal.button.armAria': '用下一条消息开始 Mittr 目标',
  ...
  'chat.goal.criteria.title': '完成标准',
  'chat.goal.criteria.progress': '已完成 {met}/{total}',
  'chat.goal.criteria.pendingContract': '“完成”的标准会在第一轮之后确定。',
  'chat.goal.criteria.status.met': '已达成',
  'chat.goal.criteria.status.missing': '尚未达成',
  'chat.goal.criteria.status.needsPerson': '需要你处理',
  'chat.goal.criteria.status.pending': '尚未检查',
  'chat.goal.criteria.checkedBy.script': '由脚本检查',
  'chat.goal.criteria.checkedBy.mittr': '由 Mittr 判定',
  'chat.goal.criteria.checkedBy.model': '由模型判定',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'MittrCraft 需要访问此文件夹。',
  ...
  'aboutDialog.mittrCraftVersionLabel': 'MittrCraft 版本 {version}',
  'aboutDialog.openCodeVersionLabel': 'MittrCraft Engine 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 MittrCraft 状态、MittrCraft Engine 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 MittrCraft',
  ...
  'header.actions.openAppMenu': 'MittrCraft 菜单',
  'header.actions.openAppMenuAria': '打开 MittrCraft 菜单',
  ...
  'chat.emptyState.opencodeUnreachable': '无法连接 MittrCraft Engine',
  ...
  'openCodeStatusDialog.title': 'MittrCraft Engine 状态',
  'openCodeStatusDialog.description': '查看当前 MittrCraft Engine 状态与诊断信息。',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 MittrCraft，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 MittrCraft',
  ...
  'sessionAuth.locked.microsoftDescription': '请使用你的 Microsoft 帐户登录。',
  'sessionAuth.locked.microsoftBrowserDescription': '可在浏览器中使用 Microsoft 登录。',
  'sessionAuth.actions.signInWithMicrosoft': '使用 Microsoft 登录',
  'sessionAuth.divider.or': '或',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 MittrCraft 服务器之间切换',
  ...
  'multiRun.window.description': 'MittrCraft 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 MittrCraft',
  ...
  'onboarding.localSetup.title': '设置 MittrCraft Engine',
  'onboarding.localSetup.description': '安装 MittrCraft Engine 以继续。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '选择 MittrCraft Engine 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'MittrCraft Engine 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 MittrCraft Engine。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 MittrCraft 未自动检测到 MittrCraft Engine，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'MittrCraft Engine 是 MittrCraft 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'MittrCraft Engine 文档',
  'onboarding.localSetup.docs.default': 'MittrCraft Engine 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 MittrCraft Engine 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 MittrCraft Engine',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 MittrCraft Engine 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 MittrCraft 设置并重新加载 MittrCraft Engine 配置。',
  'onboarding.localSetup.remotePreference': '更希望使用远程服务器？',
  'onboarding.localSetup.actions.connectRemoteServer': '连接远程服务器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，请原生安装并运行 MittrCraft Engine。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 MittrCraft 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 MittrCraft 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 MittrCraft。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 MittrCraft，但与此应用版本不兼容。请更新服务器上的 MittrCraft 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 MittrCraft。请确认地址是否指向 MittrCraft 服务器。',
  'onboarding.remoteConnection.probe.unreachableMessage': '服务器不可达。请检查网络连接并确认服务器地址。',
  'onboarding.desktopRecovery.localUnavailable.title': '本地 MittrCraft Engine 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'MittrCraft Engine 无法启动或未安装。请安装 MittrCraft Engine，或改为连接远程服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 MittrCraft。请确认地址是否指向 MittrCraft 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 MittrCraft 服务器与此应用版本不兼容。请更新服务器上的 MittrCraft 后重试。',
  ...
  'startup.initRecovery.description': 'MittrCraft 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.header.updating': '正在更新 MittrCraft...',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：mittrcraft update',
  'mobileUpdate.toast.available.title': 'MittrCraft 更新可用',
  ...
  'mittrCraftLogo.aria.logo': 'MittrCraft 标志',
  ...
  'mittr.audit.notice': '你输入的指令会被记录，Mittr 管理员可以查看。你的代码和文件不会被记录。',
  'mittr.model.refused.entitlement': '你没有该模型的使用权限。请让 Mittr 管理员为你开通。',
  'mittr.model.refused.staleCatalog': '该模型已不再由 Mittr 提供。请刷新目录查看可用的模型。',
  'mittr.model.refused.unknown': 'Mittr 拒绝了此请求。',
};
