...
export const settingsDict = {
  ...
  'settings.openchamber.tools.field.agentMemoryToolAria': 'Włącz narzędzie pamięci agenta',
  'settings.openchamber.tools.field.agentMemoryToolInfo': 'Pozwala agentom zachowywać wiedzę między sesjami w dwóch magazynach: informacje o Tobie oraz informacje o każdym projekcie. Sesje otrzymują zapisane tytuły, aby agent mógł odczytać wpis, gdy jest istotny. Wyłączenie usuwa narzędzie, kartę Pamięć i indeks sesji. Zastosowane po ponownym uruchomieniu OpenCode.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie MittrCraft',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie MittrCraft',
