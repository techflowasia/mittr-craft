...
export const settingsDict = {
  ...
  'settings.openchamber.about.title': 'O MittrCraft',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj MittrCraft przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj MittrCraft przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj MittrCraft na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj MittrCraft na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu MittrCraft nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Zamykaj MittrCraft do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje MittrCraft w zasobniku systemowym, gdy główne okno zostanie zamknięte. Minimalizacja pozostawia okno na pasku zadań.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy MittrCraft jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy MittrCraft jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'MittrCraft pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.openchamber.tools.title': 'Narzędzia MittrCraft',
  ...
  'settings.openchamber.tools.field.agentMemoryTool': 'Narzędzie pamięci dla agentów',
  'settings.openchamber.tools.field.agentMemoryToolAria': 'Narzędzie pamięci dla agentów',
  'settings.openchamber.tools.field.agentMemoryToolInfo': 'Pozwól agentom zapamiętywać nauki z sesji, w dwóch magazynach: co jest prawdą o Tobie i co jest prawdą o każdym projekcie. Sesje otrzymują zapisane tytuły, aby agent mógł przeczytać wpis, gdy jest relevant. Wyłączenie usuwa narzędzie, kartę Memory i indeks sesji. Zastosowane po ponownym uruchomieniu OpenCode.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez MittrCraft.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Przechowywany w auth OpenCode, nie przez MittrCraft. Użyj {env:VAR_NAME}, aby odczytać klucz ze zmiennej środowiskowej.',
