...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Skopiuj ID z adresu panelu i cookie auth z narzędzi deweloperskich przeglądarki. Mittr Craft nigdy nie skanuje plików cookie przeglądarki.',
  ...
  'settings.github.page.flow.title': 'Autoryzuj Mittr Craft',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Dostępne jako rezerwa, jeśli uwierzytelnienie Mittr Craft zostanie usunięte',
  ...
  'settings.notifications.page.testNotification.body': 'To jest powiadomienie testowe z Mittr Craft.',
  ...
  'settings.openchamber.about.title': 'O Mittr Craft',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj Mittr Craft przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj Mittr Craft przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj Mittr Craft na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj Mittr Craft na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu Mittr Craft nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Zamykaj Mittr Craft do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje Mittr Craft w zasobniku systemowym, gdy główne okno zostanie zamknięte. Minimalizacja pozostawia okno na pasku zadań.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy Mittr Craft jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy Mittr Craft jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'Mittr Craft pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.openchamber.tools.title': 'Narzędzia Mittr Craft',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Narzędzie Mittr Craft Web',
  'settings.openchamber.tools.field.agentWebToolAria': 'Włącz narzędzie Mittr Craft Web',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Pozwól agentom oglądać stronę w panelu przeglądarki Mittr Craft i wchodzić z nią w interakcję: otwierać adres URL, czytać treść, klikać, pisać, przewijać i przełączać między układem mobilnym a desktopowym. Dodaje krótki opis narzędzia do każdej sesji. Zastosowane po ponownym uruchomieniu OpenCode.',
  ...
  'settings.page.appearance.description': 'Dostosuj wygląd i odczucie Mittr Craft.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez Mittr Craft.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Przechowywany w auth OpenCode, nie przez Mittr Craft. Użyj {env:VAR_NAME}, aby odczytać klucz ze zmiennej środowiskowej.',
  ...
  'settings.remoteInstances.page.description': 'Połącz się z inną maszyną przez SSH i otwórz tam Mittr Craft.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'Jak Mittr Craft ma zostać umieszczony na zdalnej maszynie, gdy aplikacja uruchamia go za Ciebie.',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': 'Pozostaw Mittr Craft uruchomiony na zdalnej maszynie po rozłączeniu.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Wybierz, czy Mittr Craft ma uruchomić serwer za Ciebie, czy połączyć się z już działającym.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie Mittr Craft',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie Mittr Craft',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Opcjonalne dane logowania dla SSH i zdalnego interfejsu Mittr Craft.',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Wybierz lokalny adres używany do otwierania tego zdalnego serwera Mittr Craft.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Mittr Craft na zdalnej maszynie',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Wybierz, jak Mittr Craft ma działać po połączeniu SSH.',
  ...
  'settings.remoteInstances.direct.title': 'Inne serwery Mittr Craft',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Dodaj inny serwer Mittr Craft przez URL. Użyj tego, gdy serwer już działa i masz token połączenia.',
  ...
  'settings.remoteInstances.direct.import.description': 'Wklej link połączenia z innego serwera Mittr Craft.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Nieprawidłowy link połączenia Mittr Craft.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Utwórz bezpieczny link lub token, aby Mittr Craft Desktop mógł połączyć się z tym serwerem.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Kod QR połączenia Mittr Craft',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Powiększ kod QR',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Zeskanuj to aplikacją Mittr Craft na drugim urządzeniu. Jednorazowy i wygasa.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Działa w domu i poza nim. Poza domem ruch przechodzi przez Mittr Craft Private Relay — szyfrowany end-to-end tunel. Bez konfiguracji.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Zeskanuj ten kod QR aplikacją Mittr Craft na drugim urządzeniu.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Dodaj repozytorium Git jako nowe źródło katalogu. Mittr Craft przeskanuje je w poszukiwaniu folderów zawierających',
  ...
  'settings.voice.page.tooltip.sttLocal': 'Transkrypcja lokalna na serwerze Mittr Craft. Modele pobierają się automatycznie; klucz API nie jest potrzebny.',
  'settings.voice.page.tooltip.localTts': 'Lokalna synteza na serwerze Mittr Craft (Kokoro, angielski). Model pobiera się automatycznie; klucz API nie jest potrzebny.',
  ...
  'settings.window.description': 'Okno ustawień Mittr Craft.',
