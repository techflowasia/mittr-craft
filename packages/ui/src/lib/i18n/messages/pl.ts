...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Mittr Craft, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Mittr Craft został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z Mittr Craft',
  ...
  'mobile.connect.password.placeholder': 'Hasło Mittr Craft',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia Mittr Craft.',
  ...
  'mobile.connect.relay.badge': 'przez Mittr Craft Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem Mittr Craft.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O Mittr Craft',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Mittr Craft.',
  ...
  'onboarding.chooser.title': 'Witaj w Mittr Craft',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Mittr Craft nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Mittr Craft i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Mittr Craft aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Mittr Craft, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Mittr Craft. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Mittr Craft, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Mittr Craft na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Mittr Craft. Zweryfikuj czy adres wskazuje na serwer Mittr Craft.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Mittr Craft. Zweryfikuj czy adres wskazuje na serwer Mittr Craft.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Mittr Craft pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Mittr Craft na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Mittr Craft nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Mittr Craft, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja Mittr Craft {version}',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer Mittr Craft, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest Mittr Craft, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest Mittr Craft. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Mittr Craft — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Mittr Craft',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Mittr Craft potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w Mittr Craft. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu Mittr Craft',
  'header.actions.openAppMenuAria': 'Otwórz menu Mittr Craft',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Mittr Craft.',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz Mittr Craft z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Mittr Craft',
  ...
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja Mittr Craft',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Mittr Craft...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw Mittr Craft otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce Mittr Craft — zainstaluj je, aby zacząć.',
