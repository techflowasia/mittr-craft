...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj MittrCraft, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'MittrCraft został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z MittrCraft',
  ...
  'mobile.connect.password.placeholder': 'Hasło MittrCraft',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia MittrCraft.',
  ...
  'mobile.connect.relay.badge': 'przez MittrCraft Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem MittrCraft.',
  ...
  'sessions.sidebar.header.actions.myWork': 'My work',
  'sessions.myWork.dialog.title': 'My work',
  'sessions.myWork.dialog.description': 'Your open work items from the Mittr platform.',
  'sessions.myWork.dialog.loading': 'Loading your work...',
  'sessions.myWork.dialog.notConnected': 'The Mittr platform is not connected yet.',
  'sessions.myWork.dialog.empty': 'No work items assigned to you.',
  'sessions.myWork.dialog.error': 'Failed to load work items',
  'sessions.myWork.dialog.noPhase': 'No phase',
  'sessions.myWork.dialog.actions.refresh': 'Refresh',
  'sessions.myWork.dialog.row.priority': 'Priority: {priority}',
  'sessions.myWork.dialog.row.due': 'Due {due}',
  "sessions.myWork.dialog.filter.placeholder": "Filter by title...",
  ...
  "sessions.myWork.dialog.toast.startFailed": "Could not start a session for this item",
  "sessions.myWork.dialog.projectMenu.label": "W którym projekcie zacząć?",
  "sessions.myWork.dialog.projectMenu.empty": "Najpierw dodaj projekt",
  "sessions.myWork.dialog.error.noModelSelected": "No model is selected yet",
  "sessions.myWork.dialog.prompt.jira": "อ่าน Jira issue {key} ({title}) ที่ {url} แล้วบอกว่าต้องทำอะไร",
  "sessions.myWork.dialog.prompt.plane": "อ่านงาน \"{title}\" ที่ {url} แล้วบอกว่าต้องทำอะไร",
  ...
  'sessions.sidebar.footer.actions.aboutMittrCraft': 'O MittrCraft',
  ...
  'sessions.sidebar.footer.profile.details.email': 'E-mail',
  'sessions.sidebar.footer.profile.details.department': 'Dział',
  'sessions.sidebar.footer.profile.details.jobTitle': 'Stanowisko',
  'sessions.sidebar.footer.profile.details.groups': 'Grupy',
  ...
  'chat.emptyState.opencodeUnreachable': 'MittrCraft Engine jest nieosiągalny',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia MittrCraft.',
  ...
  'onboarding.chooser.title': 'Witaj w MittrCraft',
  ...
  'onboarding.localSetup.title': 'Konfiguracja MittrCraft Engine',
  'onboarding.localSetup.description': 'Zainstaluj CLI MittrCraft Engine aby kontynuować.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Wybierz binarkę opencode',
  'onboarding.localSetup.errors.cliNotReady': 'MittrCraft Engine nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj MittrCraft Engine za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli MittrCraft nie wykryje MittrCraft Engine automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'Dokumentacja MittrCraft Engine',
  'onboarding.localSetup.docs.default': 'Wyświetl dokumentację',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy MittrCraft Engine jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki MittrCraft Engine:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień MittrCraft i przeładowuje konfigurację MittrCraft Engine.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'W Windows zainstaluj i uruchom MittrCraft Engine natywnie.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera MittrCraft aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer MittrCraft, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji MittrCraft. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia MittrCraft, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj MittrCraft na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim MittrCraft. Zweryfikuj czy adres wskazuje na serwer MittrCraft.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'MittrCraft Engine lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić MittrCraft Engine lub nie jest zainstalowany. Zainstaluj MittrCraft Engine lub połącz się z serwerem zdalnym.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia MittrCraft. Zweryfikuj czy adres wskazuje na serwer MittrCraft.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer MittrCraft pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj MittrCraft na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'MittrCraft nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan MittrCraft, kondycję MittrCraft Engine, katalogi i projekty.',
  ...
  'aboutDialog.mittrCraftVersionLabel': 'Wersja MittrCraft {version}',
  'aboutDialog.openCodeVersionLabel': 'Wersja MittrCraft Engine {version}',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer MittrCraft, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest MittrCraft, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest MittrCraft. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do MittrCraft — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'contextSidebar.activity.title': 'Aktywność',
  'contextSidebar.activity.subagent': 'Podagent',
  'contextSidebar.activity.subagentUntitled': 'Podagent bez nazwy',
  'contextSidebar.activity.elapsed': '{duration} czasu',
  'contextSidebar.activity.tokens': '{input} wej. · {output} wyj.',
  'contextSidebar.activity.step': 'Krok {index} z {total}',
  'contextSidebar.activity.working': 'W toku',
  'contextSidebar.activity.modelTokens': '{model} · {tokens} tokenów',
  'contextSidebar.activity.empty': 'Brak aktywności',
  'contextSidebar.rawMessages.roleUser': 'Użytkownik',
  'contextSidebar.rawMessages.column.tokens': 'wej. / wyj.',
  'contextSidebar.rawMessages.tokensAria': '{input} tokenów wejściowych, {output} tokenów wyjściowych',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami MittrCraft',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'MittrCraft potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w MittrCraft. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu MittrCraft',
  'header.actions.openAppMenuAria': 'Otwórz menu MittrCraft',
  ...
  'chat.goal.dialog.titleCreate': 'Ustaw cel Mittr',
  'chat.goal.dialog.titleManage': 'Cel Mittr',
  ...
  'chat.goal.button.armAria': 'Rozpocznij cel Mittr następną wiadomością',
  ...
  'chat.goal.criteria.title': 'Gotowe, gdy',
  'chat.goal.criteria.progress': '{met}/{total} gotowe',
  'chat.goal.criteria.pendingContract': 'Co znaczy „gotowe”, zostanie ustalone po pierwszej turze.',
  'chat.goal.criteria.status.met': 'Spełnione',
  'chat.goal.criteria.status.missing': 'Jeszcze niespełnione',
  'chat.goal.criteria.status.needsPerson': 'Wymaga Ciebie',
  'chat.goal.criteria.status.pending': 'Jeszcze niesprawdzone',
  'chat.goal.criteria.checkedBy.script': 'sprawdzone skryptem',
  'chat.goal.criteria.checkedBy.mittr': 'ocenione przez Mittr',
  'chat.goal.criteria.checkedBy.model': 'ocenione przez model',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po MittrCraft.',
  ...
  'mittrCraftLogo.aria.logo': 'Logo MittrCraft',
  'openCodeStatusDialog.actions.copy': 'Kopiuj',
  'openCodeStatusDialog.description': 'Sprawdź bieżący status i diagnostykę MittrCraft Engine.',
  'openCodeStatusDialog.empty.noData': 'Brak danych.',
  'openCodeStatusDialog.title': 'Status MittrCraft Engine',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz MittrCraft z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj MittrCraft',
  'sessionAuth.password.placeholder': 'Wpisz hasło',
  'sessionAuth.locked.microsoftDescription': 'Zaloguj się przy użyciu konta Microsoft.',
  'sessionAuth.locked.microsoftBrowserDescription': 'Logowanie przez Microsoft jest dostępne w przeglądarce.',
  'sessionAuth.actions.signInWithMicrosoft': 'Zaloguj się przez Microsoft',
  'sessionAuth.divider.or': 'lub',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: mittrcraft update',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja MittrCraft',
  ...
  'updateDialog.header.updating': 'Aktualizowanie MittrCraft...',
  ...
  'onboarding.localSetup.intro': 'MittrCraft Engine to serce MittrCraft — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na MittrCraft Engine',
  ...
  'settings.mittrcraft.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.mittrcraft.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.mittrcraft.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.mittrcraft.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.mittrcraft.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.mittrcraft.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.mittrcraft.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.mittrcraft.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
  ...
  'mittr.signIn.title': 'Zaloguj się do MittrCraft',
  'mittr.signIn.description': 'Zaloguj się kontem Mittr, aby kontynuować.',
  'mittr.signIn.action': 'Zaloguj się przez Mittr',
  'mittr.signIn.checking': 'Sprawdzanie sesji…',
  'mittr.signIn.error': 'Nie udało się rozpocząć logowania. Spróbuj ponownie.',
  'mittr.audit.notice': 'Twoje polecenia są zapisywane i widoczne dla administratorów Mittr. Twój kod i pliki nie.',
  'mittr.model.refused.entitlement': 'Nie masz dostępu do tego modelu. Poproś administratora Mittr o przyznanie dostępu.',
  'mittr.model.refused.staleCatalog': 'Ten model nie jest już dostępny w Mittr. Odśwież katalog, aby zobaczyć dostępne modele.',
  'mittr.model.refused.unknown': 'Mittr odrzucił to żądanie.',
} as const;
