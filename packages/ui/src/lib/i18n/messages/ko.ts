...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 MittrCraft를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'MittrCraft가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'MittrCraft에 연결',
  ...
  'mobile.connect.password.placeholder': 'MittrCraft 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 MittrCraft 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'MittrCraft Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 MittrCraft 서버에 연결할 수 없습니다.',
  ...
  "sessions.myWork.dialog.projectMenu.label": "어느 프로젝트에서 시작할까요?",
  "sessions.myWork.dialog.projectMenu.empty": "먼저 프로젝트를 추가하세요",
  ...
  'sessions.sidebar.footer.actions.aboutMittrCraft': 'MittrCraft 정보',
  ...
  'sessions.sidebar.footer.profile.details.email': '이메일',
  'sessions.sidebar.footer.profile.details.department': '부서',
  'sessions.sidebar.footer.profile.details.jobTitle': '직함',
  'sessions.sidebar.footer.profile.details.groups': '그룹',
  ...
  'walkthrough.blocked.serverUnsupported.description': '이 앱이 연결된 MittrCraft 서버가 워크스루 API에 응답하지 않았습니다. 즉 앱보다 오래된 버전입니다. 서버를 1.18 이상으로 업데이트한 뒤 새로 고치세요.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 은(는) MittrCraft가 실행 중인 컴퓨터에 있으며, 그곳으로의 연결을 열지 못했습니다. 이 화면에는 사용자 컴퓨터의 내용이 표시되지 않습니다.',
  ...
  'contextPanel.browser.devServers.remoteOnly': '이 서버들은 MittrCraft가 실행 중인 컴퓨터에 있습니다. 열려면 데스크톱 앱이 필요합니다.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 MittrCraft에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 MittrCraft에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  ...
  'contextSidebar.activity.title': '활동',
  'contextSidebar.activity.subagent': '서브에이전트',
  'contextSidebar.activity.subagentUntitled': '제목 없는 서브에이전트',
  'contextSidebar.activity.elapsed': '경과 {duration}',
  'contextSidebar.activity.tokens': '입력 {input} · 출력 {output}',
  'contextSidebar.activity.step': '{total}단계 중 {index}단계',
  'contextSidebar.activity.working': '진행 중',
  'contextSidebar.activity.modelTokens': '{model} · {tokens} 토큰',
  'contextSidebar.activity.empty': '아직 활동이 없습니다',
  'contextSidebar.rawMessages.roleUser': '사용자',
  'contextSidebar.rawMessages.column.tokens': '입력 / 출력',
  'contextSidebar.rawMessages.tokensAria': '입력 {input} 토큰, 출력 {output} 토큰',
  ...
  'chat.recap.label': '요약:',
  'chat.goal.dialog.titleCreate': 'Mittr 목표 설정',
  'chat.goal.dialog.titleManage': 'Mittr 목표',
  ...
  'chat.goal.button.armAria': '다음 메시지로 Mittr 목표 시작',
  ...
  'chat.goal.criteria.title': '완료 조건',
  'chat.goal.criteria.progress': '{met}/{total} 완료',
  'chat.goal.criteria.pendingContract': '"완료"의 기준은 첫 번째 턴 이후에 정해집니다.',
  'chat.goal.criteria.status.met': '충족',
  'chat.goal.criteria.status.missing': '아직 미충족',
  'chat.goal.criteria.status.needsPerson': '확인 필요',
  'chat.goal.criteria.status.pending': '아직 확인 안 됨',
  'chat.goal.criteria.checkedBy.script': '스크립트로 확인',
  'chat.goal.criteria.checkedBy.mittr': 'Mittr가 판정',
  'chat.goal.criteria.checkedBy.model': '모델이 판정',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'MittrCraft에서 이 폴더에 접근해야 합니다.',
  ...
  'aboutDialog.mittrCraftVersionLabel': 'MittrCraft 버전 {version}',
  'aboutDialog.openCodeVersionLabel': 'MittrCraft Engine 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'MittrCraft 상태, MittrCraft Engine 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 MittrCraft를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'MittrCraft 메뉴',
  'header.actions.openAppMenuAria': 'MittrCraft 메뉴 열기',
  ...
  'chat.emptyState.opencodeUnreachable': 'MittrCraft Engine에 연결할 수 없음',
  ...
  'openCodeStatusDialog.title': 'MittrCraft Engine 상태',
  'openCodeStatusDialog.description': '현재 MittrCraft Engine 상태와 진단 정보를 확인합니다.',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 MittrCraft를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'MittrCraft 잠금 해제',
  ...
  'sessionAuth.locked.microsoftDescription': 'Microsoft 계정으로 로그인하세요.',
  'sessionAuth.locked.microsoftBrowserDescription': 'Microsoft 로그인은 브라우저에서 사용할 수 있습니다.',
  'sessionAuth.actions.signInWithMicrosoft': 'Microsoft로 로그인',
  'sessionAuth.divider.or': '또는',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 MittrCraft 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'MittrCraft 멀티런 창.',
  ...
  'onboarding.chooser.title': 'MittrCraft에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.title': 'MittrCraft Engine 설정',
  'onboarding.localSetup.description': '계속하려면 MittrCraft Engine를 설치하세요.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'opencode 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'MittrCraft Engine가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 MittrCraft Engine를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'MittrCraft가 MittrCraft Engine를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'MittrCraft Engine는 MittrCraft의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'MittrCraft Engine 문서',
  'onboarding.localSetup.docs.default': 'MittrCraft Engine 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'MittrCraft Engine를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'MittrCraft Engine 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? MittrCraft Engine 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'MittrCraft 설정에 저장하고 MittrCraft Engine 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 MittrCraft Engine를 네이티브로 설치하고 실행하세요.',
  ...
  'onboarding.remoteConnection.description': '연결할 MittrCraft 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 MittrCraft 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 MittrCraft 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 MittrCraft가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 MittrCraft를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 MittrCraft가 실행 중이 아닙니다. 주소가 MittrCraft 서버를 가리키는지 확인하세요.',
  'onboarding.remoteConnection.probe.unreachableMessage': '서버에 연결할 수 없습니다. 네트워크 연결과 서버 주소를 확인하세요.',
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 MittrCraft Engine를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'MittrCraft Engine를 시작할 수 없거나 설치되어 있지 않습니다. MittrCraft Engine를 설치하거나 원격 서버에 연결하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 MittrCraft가 실행 중이 아닙니다. 주소가 MittrCraft 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 MittrCraft 서버가 이 앱 버전과 호환되지 않습니다. 서버의 MittrCraft를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'MittrCraft 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'MittrCraft 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `mittrcraft update`를 실행하세요.',
  'mobileUpdate.toast.available.title': 'MittrCraft 업데이트 사용 가능',
  ...
  'mittrCraftLogo.aria.logo': 'MittrCraft 로고',
  ...
  'mittr.signIn.title': 'MittrCraft에 로그인',
  'mittr.signIn.description': '계속하려면 Mittr 계정으로 로그인하세요.',
  'mittr.signIn.action': 'Mittr로 로그인',
  'mittr.signIn.checking': '세션을 확인하는 중…',
  'mittr.signIn.error': '로그인을 시작할 수 없습니다. 다시 시도하세요.',
  'mittr.audit.notice': '입력한 지시는 기록되며 Mittr 관리자가 볼 수 있습니다. 코드와 파일은 기록되지 않습니다.',
  'mittr.model.refused.entitlement': '이 모델에 대한 접근 권한이 없습니다. Mittr 관리자에게 권한을 요청하세요.',
  'mittr.model.refused.staleCatalog': '이 모델은 더 이상 Mittr에서 제공되지 않습니다. 카탈로그를 새로 고쳐 사용할 수 있는 모델을 확인하세요.',
  'mittr.model.refused.unknown': 'Mittr가 이 요청을 거부했습니다.',
};
