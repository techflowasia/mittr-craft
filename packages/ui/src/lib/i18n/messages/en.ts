...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Mittr Craft for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Mittr Craft installed',
  ...
  'mobile.connect.welcome.title': 'Connect to Mittr Craft',
  ...
  'mobile.connect.password.placeholder': 'Mittr Craft password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not a Mittr Craft connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that Mittr Craft server.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About Mittr Craft',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The Mittr Craft server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine Mittr Craft is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting Mittr Craft. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Mittr Craft — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in Mittr Craft. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'Mittr Craft needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Mittr Craft state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Mittr Craft efficiently',
  ...
  'header.actions.openAppMenu': 'Mittr Craft menu',
  'header.actions.openAppMenuAria': 'Open Mittr Craft menu',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening Mittr Craft from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Mittr Craft',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Mittr Craft servers',
  ...
  'multiRun.window.description': 'Mittr Craft Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Mittr Craft',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Mittr Craft does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Mittr Craft — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Mittr Craft settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of a Mittr Craft server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to a Mittr Craft server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Mittr Craft version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Mittr Craft but is not compatible with this app version. Update Mittr Craft on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Mittr Craft. Verify the address points to a Mittr Craft server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Mittr Craft. Verify the address points to a Mittr Craft server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Mittr Craft server at "{host}" is not compatible with this app version. Update Mittr Craft on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Mittr Craft could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Mittr Craft...',
  ...
  'mobileUpdate.toast.available.title': 'Mittr Craft update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Mittr Craft open.',
