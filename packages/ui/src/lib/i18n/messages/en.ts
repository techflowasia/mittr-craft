...
export const dict = {
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an MittrCraft connection code.',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About MittrCraft',
...
>>>>>>> 6899349e (feat: implement Active Directory and Entra ID authentication support with session management updates)
  ...
  'aboutDialog.diagnosticsDescription': 'Includes MittrCraft state, OpenCode health, directories, and projects.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If MittrCraft does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of MittrCraft — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to MittrCraft settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an MittrCraft server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an MittrCraft server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running MittrCraft. Verify the address points to an MittrCraft server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running MittrCraft. Verify the address points to an MittrCraft server.',
