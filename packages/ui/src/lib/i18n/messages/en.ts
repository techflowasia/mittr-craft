...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install MittrCraft for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'MittrCraft installed',
  ...
  'mobile.connect.welcome.title': 'Connect to MittrCraft',
  ...
  'mobile.connect.password.placeholder': 'MittrCraft password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not a MittrCraft connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that MittrCraft server.',
  ...
  'sessions.myWork.dialog.projectMenu.label': 'Start in which project?',
  'sessions.myWork.dialog.projectMenu.empty': 'Add a project first',
  ...
  'sessions.sidebar.footer.actions.aboutMittrCraft': 'About MittrCraft',
  ...
  'sessions.sidebar.footer.profile.details.email': 'Email',
  'sessions.sidebar.footer.profile.details.department': 'Department',
  'sessions.sidebar.footer.profile.details.jobTitle': 'Job title',
  'sessions.sidebar.footer.profile.details.groups': 'Groups',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The MittrCraft server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine MittrCraft is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting MittrCraft. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to MittrCraft — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in MittrCraft. Download it to open with another app.',
  ...
  'contextSidebar.activity.title': 'Activity',
  'contextSidebar.activity.subagent': 'Subagent',
  'contextSidebar.activity.subagentUntitled': 'Untitled subagent',
  'contextSidebar.activity.elapsed': '{duration} elapsed',
  'contextSidebar.activity.tokens': '{input} in · {output} out',
  'contextSidebar.activity.step': 'Step {index} of {total}',
  'contextSidebar.activity.working': 'Working',
  'contextSidebar.activity.modelTokens': '{model} · {tokens} tokens',
  'contextSidebar.activity.empty': 'No activity yet',
  'contextSidebar.rawMessages.roleUser': 'User',
  'contextSidebar.rawMessages.column.tokens': 'in / out',
  'contextSidebar.rawMessages.tokensAria': '{input} tokens in, {output} tokens out',
  ...
  'chat.goal.dialog.titleCreate': 'Set Mittr Goal',
  'chat.goal.dialog.titleManage': 'Mittr Goal',
  ...
  'chat.goal.button.armAria': 'Start a Mittr goal with the next message',
  ...
  'chat.goal.criteria.title': 'Done when',
  'chat.goal.criteria.progress': '{met}/{total} done',
  'chat.goal.criteria.pendingContract': 'What "done" means is set after the first turn.',
  'chat.goal.criteria.status.met': 'Met',
  'chat.goal.criteria.status.missing': 'Not met yet',
  'chat.goal.criteria.status.needsPerson': 'Needs you',
  'chat.goal.criteria.status.pending': 'Not checked yet',
  'chat.goal.criteria.checkedBy.script': 'checked by script',
  'chat.goal.criteria.checkedBy.mittr': 'judged by Mittr',
  'chat.goal.criteria.checkedBy.model': 'judged by the model',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'MittrCraft needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes MittrCraft state, engine health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate MittrCraft efficiently',
  ...
  'header.actions.openAppMenu': 'MittrCraft menu',
  'header.actions.openAppMenuAria': 'Open MittrCraft menu',
  ...
  'chat.emptyState.opencodeUnreachable': 'MittrCraft Engine is not reachable',
  ...
  'openCodeStatusDialog.description': 'Inspect current MittrCraft Engine status and diagnostics.',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening MittrCraft from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock MittrCraft',
  ...
  'sessionAuth.locked.microsoftDescription': 'Sign in with your Microsoft account.',
  'sessionAuth.locked.microsoftBrowserDescription': 'Microsoft sign-in is available in a browser.',
  'sessionAuth.actions.signInWithMicrosoft': 'Sign in with Microsoft',
  'sessionAuth.divider.or': 'or',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote MittrCraft servers',
  ...
  'multiRun.window.description': 'MittrCraft Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to MittrCraft',
  ...
  'onboarding.localSetup.title': 'Setting Up MittrCraft Engine',
  'onboarding.localSetup.description': 'Install MittrCraft Engine to continue.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Select opencode binary',
  'onboarding.localSetup.errors.cliNotReady': 'MittrCraft Engine is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install MittrCraft Engine with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If MittrCraft does not detect the engine automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'The engine is the heart of MittrCraft — install it to get started.',
  'onboarding.localSetup.docs.windows': 'MittrCraft Engine docs',
  'onboarding.localSetup.docs.default': 'MittrCraft Engine docs',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if MittrCraft Engine is available. If successful, you\'ll automatically enter the main screen.',
  'onboarding.localSetup.status.watching': 'Waiting for MittrCraft Engine',
  'onboarding.localSetup.status.autoContinue': "We'll continue automatically once it's detected.",
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the MittrCraft Engine path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to MittrCraft settings and reloads the engine configuration.',
  ...
  'onboarding.localSetup.windows.hintInstallInWsl': 'On Windows, install and run MittrCraft Engine natively.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of a MittrCraft server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to a MittrCraft server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different MittrCraft version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running MittrCraft but is not compatible with this app version. Update MittrCraft on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running MittrCraft. Verify the address points to a MittrCraft server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local MittrCraft Engine Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'MittrCraft Engine could not be started or is not installed. Install it or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running MittrCraft. Verify the address points to a MittrCraft server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The MittrCraft server at "{host}" is not compatible with this app version. Update MittrCraft on the server, then try again.',
  ...
  'startup.initRecovery.description': 'MittrCraft could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating MittrCraft...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: mittrcraft update',
  'mobileUpdate.toast.available.title': 'MittrCraft update available',
