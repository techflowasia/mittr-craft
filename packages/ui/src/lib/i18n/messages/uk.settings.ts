...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Скопіюйте ID робочого простору з URL панелі, а cookie auth з інструментів розробника браузера. Mittr Craft ніколи не сканує сховище cookie браузера.',
  ...
  "settings.window.description": "Вікно налаштувань Mittr Craft.",
  ...
  "settings.page.appearance.description": "Налаштуйте вигляд і відчуття Mittr Craft.",
  ...
  "settings.remoteInstances.direct.title": "Інші сервери Mittr Craft",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Додайте інший сервер Mittr Craft за URL. Використовуйте це, коли сервер уже запущений і у вас є токен підключення.",
  ...
  "settings.remoteInstances.direct.import.description": "Вставте посилання для підключення з іншого сервера Mittr Craft.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Недійсне посилання підключення Mittr Craft.",
  ...
  "settings.remoteInstances.clientAuth.description": "Створіть безпечне посилання або токен, щоб Mittr Craft Desktop міг підключитися до цього сервера.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "QR-код підключення Mittr Craft",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Збільшити QR-код",
  "settings.remoteInstances.clientAuth.qrScanHint": "Скануй це застосунком Mittr Craft на іншому пристрої. Одноразовий і має термін дії.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Працює вдома і поза домом. Поза домом трафік іде через Mittr Craft Private Relay — наскрізно зашифрований тунель. Нічого налаштовувати не треба.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Відскануйте цей QR-код застосунком Mittr Craft на іншому пристрої.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Виберіть, чи Mittr Craft має запустити сервер для вас, чи підключитися до вже запущеного.",
  ...
  "settings.remoteInstances.page.field.keepServerRunningHint": "Залишати Mittr Craft запущеним на віддаленій машині після відключення.",
  ...
  "settings.openchamber.about.title": "Про Mittr Craft",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Додати репозиторій Git як нове джерело каталогу. Mittr Craft просканує його на наявність папок, що містять",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Запускати Mittr Craft під час входу в систему",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Запускати Mittr Craft під час входу в систему",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Показувати Mittr Craft у смузі меню macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Показувати Mittr Craft у смузі меню",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Потребує перезапуску застосунку. Якщо вимкнено, Mittr Craft не створює елемент смуги меню та не запускає пов’язані оновлення сесій, запитів на підтвердження й використання.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Закривати Mittr Craft у системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Закривати в системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Залишає Mittr Craft запущеним у системному треї, коли головне вікно закрито. Під час згортання вікно залишається на панелі завдань.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Не давати комп’ютеру засинати, поки Mittr Craft запущено",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Не давати комп’ютеру засинати, поки Mittr Craft запущено",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "Mittr Craft попросить пароль після перезапуску, а потім коли сесія логіну спливе: через 12 годин або через 7 днів із «Довіряти цьому пристрою». Залиште порожнім, щоб вимкнути логін.",
  ...
  "settings.openchamber.tools.title": "Інструменти Mittr Craft",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Інструмент Mittr Craft Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Увімкнути інструмент Mittr Craft Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Дозвольте агентам переглядати сторінку в панелі браузера Mittr Craft і взаємодіяти з нею: відкривати URL, читати вміст, клікати, вводити текст, гортати та перемикатися між мобільним і десктопним виглядом. Додає невеликий опис інструмента до кожної сесії. Застосовується після перезапуску OpenCode.",
  ...
  "settings.remoteInstances.page.description": "Підключіться до іншої машини через SSH і відкрийте там Mittr Craft.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "Mittr Craft на віддаленій машині",
  "settings.remoteInstances.page.section.remoteServerDescription": "Виберіть, як Mittr Craft має працювати після SSH-підключення.",
  "settings.remoteInstances.page.section.mainTunnel": "Локальний доступ",
  "settings.remoteInstances.page.section.mainTunnelDescription": "Виберіть локальну адресу, через яку відкриватиметься цей віддалений сервер Mittr Craft.",
  "settings.remoteInstances.page.section.authentication": "Аутентифікація",
  "settings.remoteInstances.page.section.authenticationDescription": "Додаткові облікові дані для SSH та віддаленого інтерфейсу користувача Mittr Craft.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Як розмістити Mittr Craft на віддаленій машині, коли цей застосунок запускає його для вас.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Встановлення Mittr Craft",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Оновлення Mittr Craft",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Зберігається в автентифікації OpenCode, не Mittr Craft. Використовуйте {env:VAR_NAME}, щоб читати ключ зі змінної середовища.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Ключі надсилаються безпосередньо до OpenCode і ніколи не зберігаються в Mittr Craft.",
  ...
  "settings.github.page.flow.title": "Авторизувати Mittr Craft",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Доступно як резервний варіант, якщо автентифікацію Mittr Craft видалено",
  ...
  "settings.notifications.page.testNotification.body": "Це тестове сповіщення від Mittr Craft.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Локальна розшифровка на сервері Mittr Craft. Моделі завантажуються автоматично; ключ API не потрібен.",
  "settings.voice.page.tooltip.localTts": "Локальний синтез на сервері Mittr Craft (Kokoro, англійська). Модель завантажується автоматично; ключ API не потрібен.",
