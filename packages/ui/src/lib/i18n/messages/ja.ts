...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'MittrCraftについて',
  ...
  'aboutDialog.openChamberVersionLabel': 'MittrCraft バージョン {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'MittrCraftの状態、OpenCodeの状態、ディレクトリ、プロジェクトが含まれます。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'MittrCraftがOpenCodeを自動検出しない場合、以下のパスを手動で設定します。',
  'onboarding.localSetup.intro': 'OpenCodeはMittrCraftの中核です — インストールして開始しましょう。',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'MittrCraft設定に保存し、OpenCode設定を再読み込みします。',
  ...
  'openChamberLogo.aria.logo': 'MittrCraftロゴ',
