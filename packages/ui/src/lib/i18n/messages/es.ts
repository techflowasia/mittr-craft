...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala MittrCraft para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "MittrCraft se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a MittrCraft",
  ...
  "mobile.connect.password.placeholder": "Contraseña de MittrCraft",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de MittrCraft.",
  ...
  "mobile.connect.relay.badge": "a través de MittrCraft Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de MittrCraft.",
  ...
  "sessions.myWork.dialog.projectMenu.label": "¿En qué proyecto empezar?",
  "sessions.myWork.dialog.projectMenu.empty": "Primero añade un proyecto",
  ...
  "sessions.sidebar.footer.actions.aboutMittrCraft": "Acerca de MittrCraft",
  "sessions.sidebar.footer.actions.update": "Actualizar",
  "sessions.sidebar.footer.profile.signedInAs": "Sesión iniciada como {name}",
  "sessions.sidebar.footer.profile.tooltip": "Perfil",
  "sessions.sidebar.footer.profile.logout": "Cerrar sesión",
  "sessions.sidebar.footer.profile.logoutError": "No se pudo cerrar la sesión. Inténtalo de nuevo.",
  "sessions.sidebar.footer.profile.details.title": "Detalles del perfil",
  "sessions.sidebar.footer.profile.details.username": "Nombre de usuario",
  "sessions.sidebar.footer.profile.details.displayName": "Nombre para mostrar",
  "sessions.sidebar.footer.profile.details.email": "Correo electrónico",
  "sessions.sidebar.footer.profile.details.department": "Departamento",
  "sessions.sidebar.footer.profile.details.jobTitle": "Cargo",
  "sessions.sidebar.footer.profile.details.groups": "Grupos",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de MittrCraft al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está MittrCraft y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja MittrCraft. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a MittrCraft: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en MittrCraft. Descárgalo para abrirlo con otra aplicación.",
  ...
  "contextSidebar.activity.title": "Actividad",
  "contextSidebar.activity.subagent": "Subagente",
  "contextSidebar.activity.subagentUntitled": "Subagente sin título",
  "contextSidebar.activity.elapsed": "{duration} transcurrido",
  "contextSidebar.activity.tokens": "{input} de entrada · {output} de salida",
  "contextSidebar.activity.step": "Paso {index} de {total}",
  "contextSidebar.activity.working": "En curso",
  "contextSidebar.activity.modelTokens": "{model} · {tokens} tokens",
  "contextSidebar.activity.empty": "Aún no hay actividad",
  "contextSidebar.rawMessages.roleUser": "Usuario",
  "contextSidebar.rawMessages.column.tokens": "entrada / salida",
  "contextSidebar.rawMessages.tokensAria": "{input} tokens de entrada, {output} tokens de salida",
  ...
  "chat.goal.dialog.titleCreate": "Definir objetivo Mittr",
  "chat.goal.dialog.titleManage": "Objetivo Mittr",
  ...
  "chat.goal.button.armAria": "Iniciar un objetivo Mittr con el próximo mensaje",
  ...
  "chat.goal.criteria.title": "Terminado cuando",
  "chat.goal.criteria.progress": "{met}/{total} hechos",
  "chat.goal.criteria.pendingContract": "Qué significa \"terminado\" se define después del primer turno.",
  "chat.goal.criteria.status.met": "Cumplido",
  "chat.goal.criteria.status.missing": "Aún no cumplido",
  "chat.goal.criteria.status.needsPerson": "Te necesita",
  "chat.goal.criteria.status.pending": "Aún sin comprobar",
  "chat.goal.criteria.checkedBy.script": "comprobado por script",
  "chat.goal.criteria.checkedBy.mittr": "evaluado por Mittr",
  "chat.goal.criteria.checkedBy.model": "evaluado por el modelo",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "MittrCraft necesita acceso a esta carpeta.",
  ...
  "aboutDialog.mittrCraftVersionLabel": "Versión de MittrCraft {version}",
  "aboutDialog.openCodeVersionLabel": "Versión de MittrCraft Engine {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de MittrCraft, el estado de MittrCraft Engine, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por MittrCraft de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de MittrCraft",
  "header.actions.openAppMenuAria": "Abrir menú de MittrCraft",
  ...
  "chat.emptyState.opencodeUnreachable": "MittrCraft Engine no es accesible",
  ...
  "openCodeStatusDialog.title": "Estado de MittrCraft Engine",
  "openCodeStatusDialog.description": "Inspecciona el estado actual de MittrCraft Engine y diagnósticos.",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres MittrCraft desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear MittrCraft",
  ...
  "sessionAuth.locked.microsoftDescription": "Inicia sesión con tu cuenta de Microsoft.",
  "sessionAuth.locked.microsoftBrowserDescription": "El inicio de sesión con Microsoft está disponible en un navegador.",
  "sessionAuth.actions.signInWithMicrosoft": "Iniciar sesión con Microsoft",
  "sessionAuth.divider.or": "o",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de MittrCraft",
  ...
  "multiRun.window.description": "Ventana de MittrCraft Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a MittrCraft",
  ...
  "onboarding.localSetup.title": "Configuración de MittrCraft Engine",
  "onboarding.localSetup.description": "Instala la CLI de MittrCraft Engine para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Seleccionar ejecutable de opencode",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de MittrCraft Engine aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepInstallWsl": "Instala MittrCraft Engine con el comando siguiente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si MittrCraft no detecta MittrCraft Engine automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "MittrCraft Engine es el corazón de MittrCraft. Instálalo para empezar.",
  "onboarding.localSetup.docs.windows": "Documentación de MittrCraft Engine",
  "onboarding.localSetup.docs.default": "Documentación de MittrCraft Engine",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de MittrCraft Engine está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando MittrCraft Engine",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de MittrCraft Engine:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de MittrCraft y recarga la configuración de MittrCraft Engine.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta MittrCraft Engine de forma nativa.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de MittrCraft para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor MittrCraft o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de MittrCraft. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta MittrCraft pero no es compatible con esta versión de la app. Actualiza MittrCraft en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando MittrCraft. Verifica que la dirección apunte a un servidor MittrCraft.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "MittrCraft Engine Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de MittrCraft Engine no pudo iniciarse o no está instalado. Instala MittrCraft Engine o conecta a un servidor remoto en su lugar.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando MittrCraft. Verifica que la dirección apunte a un servidor MittrCraft.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor MittrCraft en \"{host}\" no es compatible con esta versión de la app. Actualiza MittrCraft en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "MittrCraft no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando MittrCraft...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: mittrcraft update",
  "mobileUpdate.toast.available.title": "Actualización de MittrCraft disponible",
  ...
  "mittrCraftLogo.aria.logo": "Logo de MittrCraft",
  ...
  'mittr.signIn.title': 'Iniciar sesión en MittrCraft',
  'mittr.signIn.description': 'Inicia sesión con tu cuenta de Mittr para continuar.',
  'mittr.signIn.action': 'Iniciar sesión con Mittr',
  'mittr.signIn.checking': 'Comprobando tu sesión…',
  'mittr.signIn.error': 'No se pudo iniciar el inicio de sesión. Inténtalo de nuevo.',
  'mittr.audit.notice': 'Tus instrucciones se registran y los administradores de Mittr pueden verlas. Tu código y tus archivos, no.',
  'mittr.model.refused.entitlement': 'No tienes acceso a este modelo. Pide a un administrador de Mittr que te lo conceda.',
  'mittr.model.refused.staleCatalog': 'Este modelo ya no está disponible en Mittr. Actualiza tu catálogo para ver cuáles lo están.',
  'mittr.model.refused.unknown': 'Mittr rechazó esta solicitud.',
};
