...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala Mittr Craft para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "Mittr Craft se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a Mittr Craft",
  ...
  "mobile.connect.password.placeholder": "Contraseña de Mittr Craft",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de Mittr Craft.",
  ...
  "mobile.connect.relay.badge": "a través de Mittr Craft Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de Mittr Craft.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de Mittr Craft",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de Mittr Craft al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está Mittr Craft y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja Mittr Craft. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Mittr Craft: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en Mittr Craft. Descárgalo para abrirlo con otra aplicación.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Mittr Craft necesita acceso a esta carpeta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de Mittr Craft {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Mittr Craft, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Mittr Craft de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de Mittr Craft",
  "header.actions.openAppMenuAria": "Abrir menú de Mittr Craft",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres Mittr Craft desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Mittr Craft",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Mittr Craft",
  ...
  "multiRun.window.description": "Ventana de Mittr Craft Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a Mittr Craft",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Mittr Craft no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de Mittr Craft. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Mittr Craft y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Mittr Craft para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Mittr Craft o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Mittr Craft. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Mittr Craft pero no es compatible con esta versión de la app. Actualiza Mittr Craft en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Mittr Craft. Verifica que la dirección apunte a un servidor Mittr Craft.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando Mittr Craft. Verifica que la dirección apunte a un servidor Mittr Craft.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor Mittr Craft en \"{host}\" no es compatible con esta versión de la app. Actualiza Mittr Craft en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "Mittr Craft no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando Mittr Craft...",
  ...
  "mobileUpdate.toast.available.title": "Actualización de Mittr Craft disponible",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén Mittr Craft abierto.",
  ...
  "openChamberLogo.aria.logo": "Logo de Mittr Craft",
