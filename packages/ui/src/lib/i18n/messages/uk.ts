...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Про MittrCraft",
  ...
  "aboutDialog.openChamberVersionLabel": "Версія MittrCraft {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан MittrCraft, стан OpenCode, каталоги та проєкти.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо MittrCraft не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце MittrCraft. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в MittrCraft і перезавантажує конфігурацію OpenCode.",
  ...
  "openChamberLogo.aria.logo": "Логотип MittrCraft",
