...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o MittrCraft para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "MittrCraft instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao MittrCraft",
  ...
  "mobile.connect.password.placeholder": "Senha do MittrCraft",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do MittrCraft.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor MittrCraft.",
  ...
  "sessions.myWork.dialog.projectMenu.label": "Começar em qual projeto?",
  "sessions.myWork.dialog.projectMenu.empty": "Adicione um projeto primeiro",
  ...
  "sessions.sidebar.footer.actions.aboutMittrCraft": "Sobre o MittrCraft",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor MittrCraft ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o MittrCraft está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o MittrCraft. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao MittrCraft — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no MittrCraft. Baixe-o para abrir em outro aplicativo.",
  ...
  "contextSidebar.activity.title": "Atividade",
  "contextSidebar.activity.subagent": "Subagente",
  "contextSidebar.activity.subagentUntitled": "Subagente sem título",
  "contextSidebar.activity.elapsed": "{duration} decorrido",
  "contextSidebar.activity.tokens": "{input} de entrada · {output} de saída",
  "contextSidebar.activity.step": "Etapa {index} de {total}",
  "contextSidebar.activity.working": "Em andamento",
  "contextSidebar.activity.modelTokens": "{model} · {tokens} tokens",
  "contextSidebar.activity.empty": "Ainda sem atividade",
  "contextSidebar.rawMessages.roleUser": "Usuário",
  "contextSidebar.rawMessages.column.tokens": "entrada / saída",
  "contextSidebar.rawMessages.tokensAria": "{input} tokens de entrada, {output} tokens de saída",
  ...
  "chat.goal.dialog.titleCreate": "Definir meta Mittr",
  "chat.goal.dialog.titleManage": "Meta Mittr",
  ...
  "chat.goal.button.armAria": "Iniciar uma meta Mittr com a próxima mensagem",
  ...
  "chat.goal.criteria.title": "Concluído quando",
  "chat.goal.criteria.progress": "{met}/{total} feitos",
  "chat.goal.criteria.pendingContract": "O que significa \"concluído\" é definido após o primeiro turno.",
  "chat.goal.criteria.status.met": "Atendido",
  "chat.goal.criteria.status.missing": "Ainda não atendido",
  "chat.goal.criteria.status.needsPerson": "Precisa de você",
  "chat.goal.criteria.status.pending": "Ainda não verificado",
  "chat.goal.criteria.checkedBy.script": "verificado por script",
  "chat.goal.criteria.checkedBy.mittr": "avaliado pelo Mittr",
  "chat.goal.criteria.checkedBy.model": "avaliado pelo modelo",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "MittrCraft precisa acessar esta pasta.",
  ...
  "aboutDialog.mittrCraftVersionLabel": "Versão do MittrCraft {version}",
  "aboutDialog.openCodeVersionLabel": "Versão do MittrCraft Engine {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do MittrCraft, a integridade do MittrCraft Engine, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo MittrCraft com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do MittrCraft",
  "header.actions.openAppMenuAria": "Abrir menu do MittrCraft",
  ...
  "chat.emptyState.opencodeUnreachable": "MittrCraft Engine não está acessível",
  ...
  "openCodeStatusDialog.title": "Status do MittrCraft Engine",
  "openCodeStatusDialog.description": "Inspecione o status atual do MittrCraft Engine e os diagnósticos.",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o MittrCraft de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "sessionAuth.locked.microsoftDescription": "Entre com sua conta Microsoft.",
  "sessionAuth.locked.microsoftBrowserDescription": "O login com a Microsoft está disponível em um navegador.",
  "sessionAuth.actions.signInWithMicrosoft": "Entrar com a Microsoft",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do MittrCraft",
  ...
  "multiRun.window.description": "Janela do MittrCraft Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao MittrCraft",
  ...
  "onboarding.localSetup.title": "Configuração do MittrCraft Engine",
  "onboarding.localSetup.description": "Instale a CLI do MittrCraft Engine para continuar.",
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Selecionar executável de opencode",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do MittrCraft Engine ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  "onboarding.localSetup.errors.detectionFailed": "Erro de detecção",
  "onboarding.localSetup.windows.title": "Configuração no Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Instale o MittrCraft Engine com o comando abaixo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o MittrCraft não detectar o MittrCraft Engine automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "MittrCraft Engine é o coração do MittrCraft. Instale-o para começar.",
  "onboarding.localSetup.docs.windows": "Documentação do MittrCraft Engine",
  "onboarding.localSetup.docs.default": "Documentação do MittrCraft Engine",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do MittrCraft Engine está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando MittrCraft Engine",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do MittrCraft Engine:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do MittrCraft e recarregue configurações do MittrCraft Engine.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute o MittrCraft Engine nativamente.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do MittrCraft para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor MittrCraft ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do MittrCraft. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando MittrCraft, mas não é compatível com esta versão do app. Atualize o MittrCraft no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando MittrCraft. Verifique se o endereço aponta para um servidor MittrCraft.",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "MittrCraft Engine Local não disponível",
  "onboarding.desktopRecovery.localUnavailable.description": "A CLI do MittrCraft Engine não pôde ser iniciada ou não está instalada. Instale o MittrCraft Engine ou conecte um servidor remoto no lugar dela.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando MittrCraft. Verifique se o endereço aponta para um servidor MittrCraft.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor MittrCraft em \"{host}\" não é compatível com esta versão do app. Atualize o MittrCraft no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O MittrCraft não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando MittrCraft...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: mittrcraft update",
  "mobileUpdate.toast.available.title": "Atualização do MittrCraft disponível",
  ...
  "mittrCraftLogo.aria.logo": "Logo do MittrCraft",
