...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o Mittr Craft para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Mittr Craft instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao Mittr Craft",
  ...
  "mobile.connect.password.placeholder": "Senha do Mittr Craft",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do Mittr Craft.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor Mittr Craft.",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o Mittr Craft",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor Mittr Craft ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o Mittr Craft está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o Mittr Craft. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Mittr Craft — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no Mittr Craft. Baixe-o para abrir em outro aplicativo.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "Mittr Craft precisa acessar esta pasta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do Mittr Craft {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Mittr Craft, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Mittr Craft com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Mittr Craft",
  "header.actions.openAppMenuAria": "Abrir menu do Mittr Craft",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o Mittr Craft de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Mittr Craft",
  ...
  "multiRun.window.description": "Janela do Mittr Craft Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Mittr Craft",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Mittr Craft não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do Mittr Craft. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Mittr Craft e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Mittr Craft para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Mittr Craft ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Mittr Craft. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Mittr Craft, mas não é compatível com esta versão do app. Atualize o Mittr Craft no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Mittr Craft. Verifique se o endereço aponta para um servidor Mittr Craft.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Mittr Craft. Verifique se o endereço aponta para um servidor Mittr Craft.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Mittr Craft em \"{host}\" não é compatível com esta versão do app. Atualize o Mittr Craft no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O Mittr Craft não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Mittr Craft...",
  ...
  "mobileUpdate.toast.available.title": "Atualização do Mittr Craft disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o Mittr Craft aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do Mittr Craft",
