...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.about.title": "Sobre o MittrCraft",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar o MittrCraft ao fazer login",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar o MittrCraft ao fazer login",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar o MittrCraft na barra de menus do macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar o MittrCraft na barra de menus",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Exige reiniciar o aplicativo. Quando desativado, o MittrCraft não cria o item da barra de menus nem executa as atualizações de sessões, aprovações e uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Fechar o MittrCraft na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Fechar na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantém o MittrCraft em execução na bandeja do sistema quando a janela principal é fechada. Ao minimizar, a janela permanece na barra de tarefas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Manter o computador ativo enquanto o MittrCraft estiver em execução",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Manter o computador ativo enquanto o MittrCraft estiver em execução",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "O MittrCraft pede após reiniciar e depois quando a sessão expira: em 12 horas, ou 7 dias com Confiar neste dispositivo. Deixe vazio para desativar o login.",
  ...
  "settings.openchamber.tools.title": "Ferramentas do MittrCraft",
  ...
  "settings.openchamber.tools.field.agentMemoryToolAria": "Ativar a ferramenta de memória do agente",
  "settings.openchamber.tools.field.agentMemoryToolInfo": "Permite que agentes mantenham o que aprenderam entre sessões em dois armazenamentos: o que é verdadeiro sobre você e o que é verdadeiro sobre cada projeto. As sessões recebem os títulos salvos para que o agente possa ler uma entrada quando ela for relevante. Desativar remove a ferramenta, a aba Memória e o índice da sessão. Aplicado após reiniciar o OpenCode.",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Armazenada na autenticação do OpenCode, não pelo MittrCraft. Use {env:VAR_NAME} para ler uma chave do ambiente.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "As chaves são enviadas diretamente ao OpenCode e nunca são armazenadas no MittrCraft.",
