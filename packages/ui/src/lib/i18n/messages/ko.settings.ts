...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.about.title': 'MittrCraft 정보',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '로그인 시 MittrCraft 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '로그인 시 MittrCraft 시작',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '창을 열지 않고 백그라운드에서 앱을 시작합니다. 데스크톱 상태 아이콘으로 열 수 있습니다.',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'macOS 메뉴 막대에 MittrCraft 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '메뉴 막대에 MittrCraft 표시',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '앱을 다시 시작해야 합니다. 끄면 MittrCraft가 메뉴 막대 항목을 만들지 않으며 세션, 승인 및 사용량 업데이트도 실행하지 않습니다.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'MittrCraft를 시스템 트레이로 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '시스템 트레이로 닫기',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '메인 창을 닫아도 MittrCraft가 시스템 트레이에서 계속 실행됩니다. 최소화하면 창은 작업 표시줄에 남습니다.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'MittrCraft가 실행되는 동안 컴퓨터 절전 방지',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'MittrCraft가 실행되는 동안 컴퓨터 절전 방지',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'MittrCraft는 다시 시작 후 비밀번호를 요청하고, 이후 로그인 세션이 만료되면 다시 요청합니다. 기본 12시간, 이 디바이스 신뢰 선택 시 7일입니다. 로그인을 끄려면 비워 두세요.',
  ...
  'settings.openchamber.tools.title': 'MittrCraft 도구',
  ...
  'settings.openchamber.tools.field.agentMemoryToolAria': '에이전트 메모리 도구 활성화',
  'settings.openchamber.tools.field.agentMemoryToolInfo': '에이전트가 세션 간에 학습한 내용을 사용자에 대한 정보와 각 프로젝트에 대한 정보, 두 저장소에 보관할 수 있습니다. 저장된 제목이 세션에 제공되므로 관련이 있을 때 에이전트가 항목을 읽을 수 있습니다. 이 기능을 끄면 도구, 메모리 탭, 세션 인덱스가 제거됩니다. OpenCode를 다시 시작하면 적용됩니다.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'MittrCraft가 아니라 OpenCode 인증에 저장됩니다. 환경 변수에서 읽으려면 {env:VAR_NAME}을 사용하세요.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '키는 OpenCode로 직접 전송되며 MittrCraft에 저장되지 않습니다.',
