  ...
  test('rewrites current-origin absolute API URLs only', () => {
    ...
    try {
      ...
      Object.defineProperty(globalThis, 'window', {
        configurable: true,
        value: { location: { origin: 'mittrcraft-ui://app', href: 'mittrcraft-ui://app/index.html' } },
      });

      expect(buildRuntimeFetchUrl('mittrcraft-ui://app/api/config/settings')).toBe('https://api.example/api/config/settings');
