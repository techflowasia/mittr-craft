  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running Mittr Craft. Verify the address points to an Mittr Craft server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The Mittr Craft server at "${host || 'unknown'}" is not compatible with this app version. Update Mittr Craft on the server, then try again.`,
