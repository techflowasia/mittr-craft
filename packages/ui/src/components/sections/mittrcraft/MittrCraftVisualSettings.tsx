...
const THEME_MODE_OPTIONS: Array<{ value: ThemeMode; labelKey: string; descriptionKey: string }> = [
    {
        value: 'system',
        labelKey: 'settings.mittrcraft.visual.option.themeMode.system',
        descriptionKey: 'settings.mittrcraft.visual.option.themeMode.system.description',
    },
    {
        value: 'light',
        labelKey: 'settings.mittrcraft.visual.option.themeMode.light',
        descriptionKey: 'settings.mittrcraft.visual.option.themeMode.light.description',
    },
    {
        value: 'dark',
        labelKey: 'settings.mittrcraft.visual.option.themeMode.dark',
        descriptionKey: 'settings.mittrcraft.visual.option.themeMode.dark.description',
    },
];
...
const DIFF_LAYOUT_OPTIONS: Option<'dynamic' | 'inline' | 'side-by-side'>[] = [
    {
        id: 'dynamic',
        labelKey: 'settings.mittrcraft.visual.option.diffLayout.dynamic.label',
        descriptionKey: 'settings.mittrcraft.visual.option.diffLayout.dynamic.description',
    },
    {
        id: 'inline',
        labelKey: 'settings.mittrcraft.visual.option.diffLayout.inline.label',
        descriptionKey: 'settings.mittrcraft.visual.option.diffLayout.inline.description',
    },
    {
        id: 'side-by-side',
        labelKey: 'settings.mittrcraft.visual.option.diffLayout.sideBySide.label',
        descriptionKey: 'settings.mittrcraft.visual.option.diffLayout.sideBySide.description',
    },
];
...
const MERMAID_RENDERING_OPTIONS: Option<'svg' | 'ascii'>[] = [
    {
        id: 'svg',
        labelKey: 'settings.mittrcraft.visual.option.mermaidRendering.svg.label',
        descriptionKey: 'settings.mittrcraft.visual.option.mermaidRendering.svg.description',
    },
    {
        id: 'ascii',
        labelKey: 'settings.mittrcraft.visual.option.mermaidRendering.ascii.label',
        descriptionKey: 'settings.mittrcraft.visual.option.mermaidRendering.ascii.description',
    },
];

const DEFAULT_PWA_INSTALL_NAME = 'MittrCraft - AI Coding Assistant';
const PWA_ORIENTATION_OPTIONS: Option<'system' | 'portrait' | 'landscape'>[] = [
    {
        id: 'system',
        labelKey: 'settings.mittrcraft.visual.option.pwaOrientation.system.label',
        descriptionKey: 'settings.mittrcraft.visual.option.pwaOrientation.system.description',
    },
    {
        id: 'portrait',
        labelKey: 'settings.mittrcraft.visual.option.pwaOrientation.portrait.label',
        descriptionKey: 'settings.mittrcraft.visual.option.pwaOrientation.portrait.description',
    },
    {
        id: 'landscape',
        labelKey: 'settings.mittrcraft.visual.option.pwaOrientation.landscape.label',
        descriptionKey: 'settings.mittrcraft.visual.option.pwaOrientation.landscape.description',
    },
];
...
const MOBILE_KEYBOARD_MODE_OPTIONS: Option<MobileKeyboardMode>[] = [
    {
        id: 'native',
        labelKey: 'settings.mittrcraft.visual.option.mobileKeyboardMode.native.label',
        descriptionKey: 'settings.mittrcraft.visual.option.mobileKeyboardMode.native.description',
    },
    {
        id: 'resize-content',
        labelKey: 'settings.mittrcraft.visual.option.mobileKeyboardMode.resizeContent.label',
        descriptionKey: 'settings.mittrcraft.visual.option.mobileKeyboardMode.resizeContent.description',
    },
];
...
const MOBILE_LAYOUT_OPTIONS: Array<{ value: MobileLayoutPreference; labelKey: string }> = [
    {
        value: 'default',
        labelKey: 'settings.mittrcraft.visual.option.mobileLayout.default',
    },
    {
        value: 'new',
        labelKey: 'settings.mittrcraft.visual.option.mobileLayout.new',
    },
];

type PwaInstallNameWindow = Window & {
    __MITTRCRAFT_SET_PWA_INSTALL_NAME__?: (value: string) => string;
    __MITTRCRAFT_SET_PWA_ORIENTATION__?: (value: 'system' | 'portrait' | 'landscape') => 'system' | 'portrait' | 'landscape';
    __MITTRCRAFT_UPDATE_PWA_MANIFEST__?: () => void;
};
...
const USER_MESSAGE_RENDERING_OPTIONS: Option<'markdown' | 'plain'>[] = [
    {
        id: 'markdown',
        labelKey: 'settings.mittrcraft.visual.option.userMessageRendering.markdown.label',
        descriptionKey: 'settings.mittrcraft.visual.option.userMessageRendering.markdown.description',
    },
    {
        id: 'plain',
        labelKey: 'settings.mittrcraft.visual.option.userMessageRendering.plain.label',
        descriptionKey: 'settings.mittrcraft.visual.option.userMessageRendering.plain.description',
    },
];
...
const CHAT_RENDER_MODE_OPTIONS: Option<'sorted' | 'live'>[] = [
    {
        id: 'sorted',
        labelKey: 'settings.mittrcraft.visual.option.chatRenderMode.sorted.label',
        descriptionKey: 'settings.mittrcraft.visual.option.chatRenderMode.sorted.description',
    },
    {
        id: 'live',
        labelKey: 'settings.mittrcraft.visual.option.chatRenderMode.live.label',
        descriptionKey: 'settings.mittrcraft.visual.option.chatRenderMode.live.description',
    },
];
...
const MESSAGE_STREAM_TRANSPORT_OPTIONS: Option<'auto' | 'ws' | 'sse'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.mittrcraft.visual.option.messageTransport.auto.label',
        descriptionKey: 'settings.mittrcraft.visual.option.messageTransport.auto.description',
    },
    {
        id: 'ws',
        labelKey: 'settings.mittrcraft.visual.option.messageTransport.ws.label',
        descriptionKey: 'settings.mittrcraft.visual.option.messageTransport.ws.description',
    },
    {
        id: 'sse',
        labelKey: 'settings.mittrcraft.visual.option.messageTransport.sse.label',
        descriptionKey: 'settings.mittrcraft.visual.option.messageTransport.sse.description',
    },
];
...
const ACTIVITY_RENDER_MODE_OPTIONS: Option<'collapsed' | 'summary'>[] = [
    {
        id: 'collapsed',
        labelKey: 'settings.mittrcraft.visual.option.activityRenderMode.collapsed.label',
        descriptionKey: 'settings.mittrcraft.visual.option.activityRenderMode.collapsed.description',
    },
    {
        id: 'summary',
        labelKey: 'settings.mittrcraft.visual.option.activityRenderMode.summary.label',
        descriptionKey: 'settings.mittrcraft.visual.option.activityRenderMode.summary.description',
    },
];
...
const TIME_FORMAT_OPTIONS: Option<'auto' | '12h' | '24h'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.mittrcraft.visual.option.timeFormat.auto.label',
        descriptionKey: 'settings.mittrcraft.visual.option.timeFormat.auto.description',
    },
    {
        id: '24h',
        labelKey: 'settings.mittrcraft.visual.option.timeFormat.24h.label',
        descriptionKey: 'settings.mittrcraft.visual.option.timeFormat.24h.description',
    },
    {
        id: '12h',
        labelKey: 'settings.mittrcraft.visual.option.timeFormat.12h.label',
        descriptionKey: 'settings.mittrcraft.visual.option.timeFormat.12h.description',
    },
];
...
const WEEK_START_OPTIONS: Option<'auto' | 'monday' | 'sunday'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.mittrcraft.visual.option.weekStart.auto.label',
        descriptionKey: 'settings.mittrcraft.visual.option.weekStart.auto.description',
    },
    {
        id: 'monday',
        labelKey: 'settings.mittrcraft.visual.option.weekStart.monday.label',
    },
    {
        id: 'sunday',
        labelKey: 'settings.mittrcraft.visual.option.weekStart.sunday.label',
    },
];
...
const FOLLOW_UP_BEHAVIOR_OPTIONS: Option<FollowUpBehavior>[] = [
    {
        id: 'steer',
        labelKey: 'settings.mittrcraft.visual.option.followUpBehavior.steer.label',
    },
    {
        id: 'queue',
        labelKey: 'settings.mittrcraft.visual.option.followUpBehavior.queue.label',
    },
];
...
const WINDOW_CONTROLS_STYLE_OPTIONS: Array<{ id: DesktopWindowControlsStyle; labelKey: string }> = [
    { id: 'classic', labelKey: 'settings.mittrcraft.desktopNetwork.option.windowControlsClassic' },
    { id: 'traffic-lights', labelKey: 'settings.mittrcraft.desktopNetwork.option.windowControlsTrafficLights' },
];

interface MittrCraftVisualSettingsProps {
    /** Which settings to show. If undefined, shows all. */
    visibleSettings?: VisibleSetting[];
}

export const MittrCraftVisualSettings: React.FC<MittrCraftVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const handleFileViewerPreviewChange = React.useCallback((enabled: boolean) => {
        ...
        window.dispatchEvent(new CustomEvent('mittrcraft:file-viewer-preview-mode-changed', { detail: { enabled } }));
    ...
    const selectedTimeFormatLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.mittrcraft.visual.option.timeFormat.auto.label');
    ...
    const selectedWeekStartLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.mittrcraft.visual.option.weekStart.auto.label');
    ...
    const applyPwaInstallName = React.useCallback(async (value: string) => {
        ...
        if (typeof win.__MITTRCRAFT_SET_PWA_INSTALL_NAME__ === 'function') {
            const resolved = win.__MITTRCRAFT_SET_PWA_INSTALL_NAME__(persistedValue);
            setPwaInstallName(resolved);
            return;
        }

        setPwaInstallName(persistedValue || DEFAULT_PWA_INSTALL_NAME);
        win.__MITTRCRAFT_UPDATE_PWA_MANIFEST__?.();
    }, []);
    ...
    const applyPwaOrientation = React.useCallback(async (value: 'system' | 'portrait' | 'landscape') => {
        ...
        if (typeof win.__MITTRCRAFT_SET_PWA_ORIENTATION__ === 'function') {
            const resolved = win.__MITTRCRAFT_SET_PWA_ORIENTATION__(normalized);
    ...
    return (
        <div className="space-y-0">
                ...
                {hasAppearanceSettings && (
                    <div className="space-y-0">
                        {hasThemeSettings && (
                            <SettingsSection title={t('settings.mittrcraft.visual.section.colorModeAndTheme')} divider={false}>
                                <SettingsTwoColumn>
                                    <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                        <SettingsRadioGroup aria-label={t('settings.mittrcraft.visual.section.colorMode')}>
                                        ...
                                        {showMobileLayoutSetting && (
                                            <SettingsInset>
                                                <SettingsStackedField label={t('settings.mittrcraft.visual.section.mobileLayout')}>
                                                    <SettingsChipGroup
                                                        ...
                                                        aria-label={t('settings.mittrcraft.visual.section.mobileLayout')}
                                                    />
                                                </SettingsStackedField>
                                            </SettingsInset>
                                        )}
                                    ...
                                    <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                        <SettingsStackedField
                                            label={t('settings.mittrcraft.visual.field.lightTheme')}
                                            settingsItem="appearance.light-theme"
                                        >
                                            <Select value={selectedLightTheme?.metadata.id ?? ''} onValueChange={setLightThemePreference}>
                                                <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.selectLightThemeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                                    <SelectValue placeholder={t('settings.mittrcraft.visual.field.selectThemePlaceholder')}>
                                                        {selectedLightTheme
                                        ...
                                        <SettingsStackedField
                                            label={t('settings.mittrcraft.visual.field.darkTheme')}
                                            settingsItem="appearance.dark-theme"
                                        >
                                            <Select value={selectedDarkTheme?.metadata.id ?? ''} onValueChange={setDarkThemePreference}>
                                                <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.selectDarkThemeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                                    <SelectValue placeholder={t('settings.mittrcraft.visual.field.selectThemePlaceholder')}>
                                                        {selectedDarkTheme
                                        ...
                                        <div className="flex items-center gap-2 pt-1">
                                            ...
                                            >
                                                ...
                                                {themesReloading ? t('settings.mittrcraft.visual.actions.reloadingThemes') : t('settings.mittrcraft.visual.actions.reloadThemes')}
                                            </button>
                                            <SettingsInfoHint>
                                                {t('settings.mittrcraft.visual.field.themeImportInfoTooltip')}
                                            </SettingsInfoHint>
                                        </div>
                                    </div>
                                </SettingsTwoColumn>
                                ...
                                {dockBadgeSupported && (
                                    <SettingsInset settingsItem="appearance.dock-badge">
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.mittrcraft.visual.field.dockBadge')}
                                            info={t('settings.mittrcraft.visual.field.dockBadgeHint')}
                                            ariaLabel={t('settings.mittrcraft.visual.field.dockBadge')}
                                        />
                                    </SettingsInset>
                                )}
                            </SettingsSection>
                        ...
                        {showWindowControlsPositionSetting && (
                            <SettingsSection
                                title={t('settings.mittrcraft.desktopNetwork.field.windowControls')}
                                info={t('settings.mittrcraft.desktopNetwork.field.windowControlsPositionDescription')}
                                divider={hasThemeSettings}
                            >
                                <SettingsTwoColumn>
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.desktopNetwork.field.windowControlsPosition')}
                                    ...
                                    >
                                        <SettingsChipGroup
                                            ...
                                            aria-label={t('settings.mittrcraft.desktopNetwork.field.windowControlsPositionAria')}
                                        />
                                    </SettingsStackedField>
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.desktopNetwork.field.windowControlsStyle')}
                                    ...
                                    >
                                        <SettingsChipGroup
                                            ...
                                            aria-label={t('settings.mittrcraft.desktopNetwork.field.windowControlsStyleAria')}
                                        />
                                    </SettingsStackedField>
                                </SettingsTwoColumn>
                            </SettingsSection>
                        ...
                        {hasLocalizationSettings && (
                            <SettingsSection title={t('settings.mittrcraft.visual.section.localization')}>
                                <SettingsTwoColumn>
                                    <SettingsStackedField
                                    ...
                                    {(shouldShow('timeFormat') || shouldShow('weekStart')) && (
                                        <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                            {shouldShow('timeFormat') && (
                                                <SettingsStackedField
                                                    label={t('settings.mittrcraft.visual.field.timeFormat')}
                                                ...
                                                >
                                                    <Select value={timeFormatPreference} onValueChange={(value: 'auto' | '12h' | '24h') => handleTimeFormatPreferenceChange(value)}>
                                                        <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.selectTimeFormatAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                            ...
                                            {shouldShow('weekStart') && (
                                                <SettingsStackedField
                                                    label={t('settings.mittrcraft.visual.field.weekStartsOn')}
                                                ...
                                                >
                                                    <Select value={weekStartPreference} onValueChange={(value: 'auto' | 'monday' | 'sunday') => handleWeekStartPreferenceChange(value)}>
                                                        <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.selectWeekStartAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                        ...
                        {(showPwaInstallNameSetting || showPwaOrientationSetting || showMobileKeyboardModeSetting) && (
                            <SettingsSection title={t('settings.mittrcraft.visual.section.appInstall')} contentClassName={SETTINGS_FIELDS_STACK_CLASS}>

                            {showPwaInstallNameSetting && (
                                <SettingsFieldRow
                                    label={t('settings.mittrcraft.visual.field.installAppName')}
                                    info={t('settings.mittrcraft.visual.field.installAppNameHint')}
                                ...
                                >
                                    <Input
                                        ...
                                        maxLength={64}
                                        aria-label={t('settings.mittrcraft.visual.field.pwaInstallAppNameAria')}
                                    />
                                    <Button size="sm"
                                        type="button"
                                        variant="ghost"
                                        ...
                                        aria-label={t('settings.mittrcraft.visual.actions.resetInstallAppNameAria')}
                            ...
                            {showPwaOrientationSetting && (
                                <SettingsFieldRow
                                    label={t('settings.mittrcraft.visual.field.installOrientation')}
                                    description={t('settings.mittrcraft.visual.field.installOrientationHint')}
                                ...
                                >
                                    ...
                                    >
                                        <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.pwaInstallOrientationAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_CLUSTER_CONTROL_CLASS}>
                                            <SelectValue placeholder={t('settings.mittrcraft.visual.field.selectOrientationPlaceholder')}>
                                    ...
                                    <Button size="sm"
                                        ...
                                        className={SETTINGS_ICON_BUTTON_CLASS}
                                        aria-label={t('settings.mittrcraft.visual.actions.resetInstallOrientationAria')}
                                        title={t('settings.common.actions.reset')}
                                    >
                                        <Icon name="restart" className="h-3.5 w-3.5" />
                                    </Button>
                            ...
                            {showMobileKeyboardModeSetting && (
                                <SettingsFieldRow
                                    label={t('settings.mittrcraft.visual.field.mobileKeyboardMode')}
                                    info={t('settings.mittrcraft.visual.field.mobileKeyboardModeHint')}
                                ...
                                >
                                    ...
                                    >
                                        <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.mobileKeyboardModeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_CLUSTER_CONTROL_CLASS}>
                                            <SelectValue placeholder={t('settings.mittrcraft.visual.field.selectMobileKeyboardModePlaceholder')}>
                                    ...
                                    <Button size="sm"
                                        ...
                                        className={SETTINGS_ICON_BUTTON_CLASS}
                                        aria-label={t('settings.mittrcraft.visual.actions.resetMobileKeyboardModeAria')}
                                        title={t('settings.common.actions.reset')}
                                    >
                                        <Icon name="restart" className="h-3.5 w-3.5" />
                                    </Button>
                ...
                {/* --- Density & type --- */}
                {hasLayoutSettings && (
                    <SettingsSection title={t('settings.mittrcraft.visual.section.densityAndType')} contentClassName={SETTINGS_FIELDS_STACK_CLASS}>
                        {(shouldShow('fontSize') && !isMobile) || shouldShow('terminalFontSize') ? (
                            <SettingsTwoColumn>
                                {shouldShow('fontSize') && !isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.visual.field.interfaceFont')}
                                        settingsItem="appearance.interface-font-size"
                                        controlClassName="w-full"
                                    >
                                        <Select value={uiFont} onValueChange={(value) => setUiFont(value as UiFontOption)}>
                                            <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.selectInterfaceFontAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className={SETTINGS_ICON_BUTTON_CLASS}
                                            aria-label={t('settings.mittrcraft.visual.actions.resetInterfaceFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                                ...
                                {shouldShow('terminalFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.visual.field.codeFont')}
                                        controlClassName="w-full"
                                    >
                                        <Select value={monoFont} onValueChange={(value) => setMonoFont(value as MonoFontOption)}>
                                            <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.selectCodeFontAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className={SETTINGS_ICON_BUTTON_CLASS}
                                            aria-label={t('settings.mittrcraft.visual.actions.resetCodeFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                        ...
                        {(shouldShow('fontSize') && !isMobile) || shouldShow('terminalFontSize') || shouldShow('editorFontSize') ? (
                            <SettingsTwoColumn>
                                {shouldShow('fontSize') && !isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.visual.field.interfaceFontSize')}
                                        controlClassName="w-full"
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            <NumberInput
                                                ...
                                                max={200}
                                                step={5}
                                                aria-label={t('settings.mittrcraft.visual.field.fontSizePercentageAria')}
                                            />
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.mittrcraft.visual.actions.resetFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('terminalFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.visual.field.terminalFontSize')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.mittrcraft.visual.actions.resetTerminalFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('editorFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.visual.field.editorFontSize')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.mittrcraft.visual.actions.resetEditorFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                        ...
                        {shouldShow('spacing') || (shouldShow('inputBarOffset') && isMobile) ? (
                            <SettingsTwoColumn>
                                {shouldShow('spacing') && (
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.visual.field.spacingDensity')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.mittrcraft.visual.actions.resetSpacingAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('inputBarOffset') && isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.mittrcraft.visual.field.inputBarOffset')}
                                        info={t('settings.mittrcraft.visual.field.inputBarOffsetTooltip')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.mittrcraft.visual.actions.resetInputBarOffsetAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                ...
                {hasNavigationSettings && (
                    <SettingsSection title={t('settings.mittrcraft.visual.section.navigation')} contentClassName="space-y-4">
                        {shouldShow('fileEditorKeymap') && (
                            <SettingsControlGroup
                                title={t('settings.mittrcraft.visual.field.fileEditorKeymap')}
                                settingsItem="appearance.file-editor-keymap"
                            >
                                <SettingsRadioGroup aria-label={t('settings.mittrcraft.visual.field.fileEditorKeymap')}>
                                    {(['default', 'vim'] as const).map((keymap) => (
                                        <SettingsRadioOption
                                            key={keymap}
                                            selected={fileEditorKeymap === keymap}
                                            onSelect={() => setFileEditorKeymap(keymap)}
                                            label={t(`settings.mittrcraft.visual.option.fileEditorKeymap.${keymap}`)}
                                            ariaLabel={t(`settings.mittrcraft.visual.option.fileEditorKeymap.${keymap}`)}
                                        />
                                    ))}
                                </SettingsRadioGroup>
                            </SettingsControlGroup>
                        ...
                        <div className={SETTINGS_OPTION_STACK_CLASS}>
                            {shouldShow('autoSaveEnabled') && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.mittrcraft.visual.field.autoSaveEnabled')}
                                    ariaLabel={t('settings.mittrcraft.visual.field.autoSaveEnabledAria')}
                                    info={t('settings.mittrcraft.visual.field.autoSaveEnabledInfo')}
                            ...
                            {shouldShow('expandedEditorToolbar') && !isVSCode && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.mittrcraft.visual.field.expandedEditorToolbar')}
                                    ariaLabel={t('settings.mittrcraft.visual.field.expandedEditorToolbarAria')}
                            ...
                            {shouldShow('terminalQuickKeys') && !isMobile && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.mittrcraft.visual.field.terminalQuickKeys')}
                                    ariaLabel={t('settings.mittrcraft.visual.field.terminalQuickKeysAria')}
                                    settingsItem="appearance.terminal-quick-keys"
                                    info={t('settings.mittrcraft.visual.field.terminalQuickKeysTooltip')}
                                />
                            )}
                            {showTerminalShellSetting && (
                                <SettingsStackedField
                                    label={t('settings.mittrcraft.visual.field.terminalShell')}
                                    info={t('settings.mittrcraft.visual.field.terminalShellHint')}
                                ...
                                >
                                    <Select value={terminalShell} onValueChange={(value) => { if (isTerminalShell(value)) setTerminalShell(value); }}>
                                        <SelectTrigger aria-label={t('settings.mittrcraft.visual.field.terminalShellAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="auto">{t('settings.mittrcraft.visual.option.terminalShell.auto')}</SelectItem>
                            ...
                            {showTerminalShellSetting && terminalShellSupportsLogin && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.mittrcraft.visual.field.terminalLoginShell')}
                                    ariaLabel={t('settings.mittrcraft.visual.field.terminalLoginShell')}
                ...
                {hasBehaviorSettings && (
                    <>
                        {showBehaviorDisplaySettings && (
                            <SettingsSection
                                title={t('settings.mittrcraft.visual.section.chatDisplay')}
                                divider={behaviorSectionDivider}
                                contentClassName="space-y-6"
                            >
                                {shouldShow('chatRenderMode') && (
                                    <SettingsControlGroup
                                        title={t('settings.mittrcraft.visual.section.chatRenderMode')}
                                        settingsItem="chat.render-mode"
                                    >
                                        <div role="radiogroup" aria-label={t('settings.mittrcraft.visual.section.chatRenderModeAria')} className="grid w-full max-w-[26rem] grid-cols-1 gap-3 @xl:grid-cols-2">
                                ...
                                {shouldShow('activityRenderMode') && chatRenderMode === 'sorted' && (
                                    <SettingsControlGroup title={t('settings.mittrcraft.visual.section.activityDefault')}>
                                        <SettingsRadioGroup aria-label={t('settings.mittrcraft.visual.section.activityDefaultAria')}>
                                            {ACTIVITY_RENDER_MODE_OPTIONS.map((option) => (
                                                <SettingsRadioOption
                                                    ...
                                                    label={tUnsafe(option.labelKey)}
                                                    ariaLabel={t('settings.mittrcraft.visual.field.activityDefaultModeAria', { option: tUnsafe(option.labelKey) })}
                                                />
                                            ))}
                                        </SettingsRadioGroup>
                                    </SettingsControlGroup>
                        ...
                        {showTransportSection && (
                            <SettingsSection
                                title={t('settings.mittrcraft.visual.section.messageStreamTransport')}
                            ...
                            >
                                <SettingsChipGroup
                                    ...
                                    aria-label={t('settings.mittrcraft.visual.section.messageStreamTransport')}
                                />
                                {(() => {
                        ...
                        {showBehaviorMessageOptions && (
                            <SettingsSection
                                title={t('settings.mittrcraft.visual.section.chatMessageOptions')}
                            ...
                            >
                                ...
                                <SettingsTwoColumn className="lg:gap-y-6">
                                    {shouldShow('userMessageRendering') && (
                                        <SettingsControlGroup title={t('settings.mittrcraft.visual.section.userMessageRendering')}>
                                            <SettingsRadioGroup aria-label={t('settings.mittrcraft.visual.section.userMessageRenderingAria')}>
                                                {USER_MESSAGE_RENDERING_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.mittrcraft.visual.field.userMessageRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('mermaidRendering') && (
                                        <SettingsControlGroup title={t('settings.mittrcraft.visual.section.mermaidRendering')}>
                                            <SettingsRadioGroup aria-label={t('settings.mittrcraft.visual.section.mermaidRenderingAria')}>
                                                {MERMAID_RENDERING_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.mittrcraft.visual.field.mermaidRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <SettingsControlGroup title={t('settings.mittrcraft.visual.section.diffLayout')}>
                                            <SettingsRadioGroup aria-label={t('settings.mittrcraft.visual.section.diffLayoutAria')}>
                                                {DIFF_LAYOUT_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.mittrcraft.visual.field.diffLayoutAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('followUpBehavior') && (
                                        <SettingsControlGroup
                                            title={t('settings.mittrcraft.visual.section.followUpBehavior')}
                                            settingsItem="chat.follow-up-behavior"
                                        >
                                            <SettingsRadioGroup aria-label={t('settings.mittrcraft.visual.section.followUpBehaviorAria')}>
                                                {FOLLOW_UP_BEHAVIOR_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.mittrcraft.visual.field.followUpBehaviorAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                        ...
                        {showBehaviorFeatureCheckboxes && (
                            <>
                                {shouldShow('expandedTools') && (
                                    <SettingsSection
                                        title={t('settings.mittrcraft.visual.section.showToolsOpenedByDefault')}
                                    ...
                                    >
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.mittrcraft.visual.field.bash')}
                                            ariaLabel={t('settings.mittrcraft.visual.field.showExpandedBashToolsAria')}
                                        />
                                        <SettingsCheckboxRow
                                            checked={showExpandedEditTools}
                                            onChange={handleShowExpandedEditToolsChange}
                                            label={t('settings.mittrcraft.visual.field.editTools')}
                                            ariaLabel={t('settings.mittrcraft.visual.field.showExpandedEditToolsAria')}
                                        />
                                    </SettingsSection>
                                )}
                                <SettingsSection
                                    title={t('settings.mittrcraft.visual.section.sessionAssistance')}
                                ...
                                >
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.draftStartersVisible')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.draftStartersVisibleAria')}
                                    ...
                                    />
                                        {shouldShow('sessionAssist') && (
                                            <>
                                                <SettingsCheckboxRow
                                                    ...
                                                    label={t('settings.mittrcraft.visual.field.sessionRecap')}
                                                    ariaLabel={t('settings.mittrcraft.visual.field.sessionRecapAria')}
                                                    settingsItem="chat.session-recap"
                                                />
                                                <SettingsCheckboxRow
                                                    checked={sessionSuggestionEnabled}
                                                    onChange={setSessionSuggestionEnabled}
                                                    label={t('settings.mittrcraft.visual.field.sessionSuggestion')}
                                                    ariaLabel={t('settings.mittrcraft.visual.field.sessionSuggestionAria')}
                                        ...
                                        {shouldShow('subagentReadOnlyBanner') && (
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.mittrcraft.visual.field.allowPromptingSubagentSessions')}
                                                ariaLabel={t('settings.mittrcraft.visual.field.allowPromptingSubagentSessionsAria')}
                                ...
                                {shouldShow('sessionGoal') && !isVSCode && (
                                    <SettingsSection
                                        title={t('settings.mittrcraft.visual.goal.sectionTitle')}
                                        info={t('settings.mittrcraft.visual.goal.description')}
                                        contentClassName={SETTINGS_OPTION_STACK_CLASS}
                                    >
                                        <SettingsCheckboxRow
                                            checked={sessionGoalEnabled}
                                            onChange={setSessionGoalEnabled}
                                            label={t('settings.mittrcraft.visual.field.sessionGoal')}
                                            ariaLabel={t('settings.mittrcraft.visual.field.sessionGoalAria')}
                                        ...
                                        <div data-settings-item="chat.session-goal-budget" className="flex items-center gap-2">
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.mittrcraft.visual.goal.budgetLabel')}
                                                ariaLabel={t('settings.mittrcraft.visual.goal.budgetAria')}
                                            />
                                ...
                                {shouldShow('reasoning') && (
                                    <SettingsSection
                                        title={t('settings.mittrcraft.visual.section.reasoning')}
                                    ...
                                    >
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.mittrcraft.visual.field.showReasoningTraces')}
                                            ariaLabel={t('settings.mittrcraft.visual.field.showReasoningTracesAria')}
                                        ...
                                        {showReasoningTraces && (
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.mittrcraft.visual.field.collapsibleThinkingBlocks')}
                                                ariaLabel={t('settings.mittrcraft.visual.field.collapsibleThinkingBlocksAria')}
                                            />
                                        )}
                                    </SettingsSection>
                                )}
                                ...
                                <SettingsSection
                                    title={t('settings.mittrcraft.visual.section.messageAppearance')}
                                ...
                                {shouldShow('collapsibleUserMessages') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.collapsibleUserMessages')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.collapsibleUserMessagesAria')}
                                ...
                                {shouldShow('stickyUserHeader') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.stickyUserHeader')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.stickyUserHeaderAria')}
                                ...
                                {shouldShow('promptNavigatorEnabled') && !isVSCode && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.promptNavigatorEnabled')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.promptNavigatorEnabledAria')}
                                ...
                                {shouldShow('wideChatLayout') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.wideChatLayout')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.wideChatLayoutAria')}
                                ...
                                {shouldShow('splitAssistantMessageActions') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.showSplitAssistantMessageActions')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.showSplitAssistantMessageActionsAria')}
                                        settingsItem="chat.inline-assistant-actions"
                                        info={t('settings.mittrcraft.visual.field.showSplitAssistantMessageActionsTooltip')}
                                    />
                                )}
                                ...
                                {shouldShow('codeBlockLineWrap') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.codeBlockLineWrap')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.codeBlockLineWrapAria')}
                                ...
                                <SettingsSection
                                    title={t('settings.mittrcraft.visual.section.toolsAndFiles')}
                                ...
                                {shouldShow('showToolFileIcons') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.showToolFileIcons')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.showToolFileIconsAria')}
                                ...
                                {shouldShow('showTurnChangedFiles') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.showTurnChangedFiles')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.showTurnChangedFilesAria')}
                                ...
                                {shouldShow('dotfiles') && !isVSCodeRuntime() && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.showDotfiles')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.showDotfilesAria')}
                                ...
                                {shouldShow('fileViewerPreview') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.defaults.field.openFilesPreview')}
                                        ariaLabel={t('settings.mittrcraft.defaults.field.openFilesPreviewAria')}
                                    />
                                )}
                                </SettingsSection>
                                )}
                                ...
                                <SettingsSection
                                    title={t('settings.mittrcraft.visual.section.composer')}
                                ...
                                {shouldShow('persistDraft') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.persistDraftMessages')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.persistDraftMessagesAria')}
                                ...
                                {!isMobile && shouldShow('inputSpellcheck') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.mittrcraft.visual.field.enableSpellcheckInTextInputs')}
                                        ariaLabel={t('settings.mittrcraft.visual.field.enableSpellcheckInTextInputsAria')}
                ...
                {shouldShow('reportUsage') && (
                    <SettingsSection title={t('settings.mittrcraft.visual.section.privacy')}>
                        <SettingsCheckboxRow
                            checked={reportUsage}
                            onChange={handleReportUsageChange}
                            label={t('settings.mittrcraft.visual.field.sendAnonymousUsageReports')}
                            info={t('settings.mittrcraft.visual.field.sendAnonymousUsageReportsHint')}
                            ariaLabel={t('settings.mittrcraft.visual.field.sendAnonymousUsageReportsAria')}
