...
const buildStartupSplashHtml = () => {
  ...
  <body>
    <div class="stack">
      <img class="splash-logo" src="${splashLogoDataUrl}" alt="Mittr Craft" onerror="this.style.display='none';this.nextElementSibling.style.display='block'" />
      <svg class="splash-logo-fallback" width="120" height="120" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Mittr Craft loading icon">
