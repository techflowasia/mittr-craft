...
Start MittrCraft locally, then run:
...
measure, then return to the terminal and press Enter. Use MittrCraft normally
...
bun run profile:browser -- --output /tmp/mittrcraft-profile
